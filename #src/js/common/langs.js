const langs = {
    en: {
        ...
        features: {
            ...
            cardDesc4: 'take any and all of your profits whenever you need to',
            ...
            desc6: 'Take your profits whenever you need to',
        },
        markets: {
            title: 'Markets',
    ...
    de: {
        ...
        hero: {
            title: 'Professionelles CFD',
            subtitle: "Handels-System",
            desc: 'Das Tor zu Ihrer finanziellen Freiheit. Nehmen Sie noch heute teil und erobern Sie die Märkte mit unseren Dienstleistungen und Lösungen',
            btnText: 'Registrieren',
        },
        features:{
            mainTitle: 'Einfacher Zugang zu Kryptowährungsinvestitionen',
            mainDesc: 'Es ist nie zu spät, Ihre Reise in die Welt der Kryptowährungen zu beginnen und eine reiche und stabile Zukunft für sich und Ihre Familie zu sichern. Wir glauben, dass finanzielle Freiheit entscheidend ist und der Zugang zu Investitionsmöglichkeiten uneingeschränkt sein sollte. Deshalb bieten wir den einfachsten, schnellsten und zugänglichen Weg für den gewöhnlichen Privatanleger, mit dem Handel zu beginnen.',
            title1: 'Sicherer und zuverlässiger Handel',
            desc1: 'Mit unserer professionellen Software auf höchstem Niveau',
            title2: 'Keine Gebühren',
            desc2: 'Handeln Sie so viel, wie Sie wollen',
            title3: 'Mehrere Konten',
            desc3: 'Verwalten Sie Ihre Gelder nach Ihren Wünschen',
            title4: 'Die liquidesten Krypto-Assets',
            desc4: 'Bitcoin, Altcoins und NFT-Indizes',
            title5: 'Handel überall',
            desc5: 'Von jedem Ort, wo es Internetzugang gibt',
            title6: 'Garantiert schnelle Auszahlungen',
            desc6: 'Nehmen Sie Ihren Gewinn, wenn Sie ihn brauchen',
        },
        cryptoNft: {
            title: 'In Kryptowährungen und NFTs investieren',
            desc: 'Kryptowährungen sind heute auf dem Höhepunkt ihrer Popularität. Es ist  derzeit der am schnellsten wachsende und profitabelste Markt des 21. Jahrhunderts. Krypto ist der Ort, an dem hochentwickelte Spitzentechnologie auf großartige Gewinnchancen trifft, denen keine Grenzen gesetzt sind. Bitcoin und Altcoins sind ein unverzichtbarer Bestandteil jedes Kryptowährungshandelssystems, aber wir haben etwas Besonderes für Sie! Die Möglichkeit, NFT-Indizes zu handeln, ist eine besondere, neue und brandheiße Funktion unserer Plattform!',
        },
        stats:{
            desc1: 'Jahre im Geschäft',
            desc2: 'monatlich aktive Nutzer',
            desc3: 'Büros weltweit',
            desc4: 'Vermögenswerte zum Handeln',
        },
        prices:{
            title: 'AKTUELLER PREIS'
        },
        optimized:{
            mainTitle: 'Mobil-optimiertes Handelserlebnis',
            mainDesc: 'Verpassen Sie keine Gelegenheit mit unserer mobilen Schnittstelle! Wann immer Sie sich von Ihrem Desktop oder Laptop entfernen, wird unsere Plattform für Sie da sein.',
            title1:'Adaptive',
            desc1: 'Die Benutzeroberfläche ist vollständig an jedes mobile Gerät anpassbar, wobei die volle Funktionalität erhalten bleibt. Handeln Sie überall und jederzeit!',
            title2:'Schnell',
            desc2: 'Unsere mobile Schnittstelle ist genauso schnell wie die Desktop-Version. Stellen Sie sicher, dass Sie eine schnelle mobile Datenverbindung haben und bleiben Sie unabhängig von den Umständen an der Spitze der Märkte!',
            title3: 'Nutzerfreundlich',
            desc3: 'In einer sich schnell verändernden Welt ist es wichtig, die Märkte im Auge zu behalten, auch wenn man unterwegs ist. Bleiben Sie mit unserer Plattform informiert und mobil!',
        },
        page: {
            forex: "WHAT IS THE FOREX MARKET?",
            stocks: "WHAT IS A STOCK?",
            crypto: "WAS IST KRYPTOWÄHRUNG? ",
            metals: "WHAT IS METALS?",
            indices: "WHAT IS A MARKET INDEX?",
            commodities: "WHAT IS COMMODITIES?",
            nft: "WAS IST EIN NICHT AUSTAUSCHBARER TOKEN (NFT)?"
        },
        forex: {
            descHead: 'The forex market allows participants, such as banks and individuals, to buy, sell or exchange currencies for both hedging and speculative purposes. The foreign exchange (forex) market is the largest financial market in the world and is made up of banks, commercial companies, central banks, investment management firms, hedge funds, retail forex brokers, and investors.',
            list1: 'The forex market allows participants, including banks, funds, and individuals to buy, sell or exchange currencies for both hedging and speculative purposes.',
        ...
        crypto: {
            descHead: 'Kryptowährung ist eine digitale oder virtuelle Währung, die durch Kryptographie geschützt ist, so dass es praktisch unmöglich ist, sie zu fälschen oder doppelt auszugeben. Bei vielen Kryptowährungen handelt es sich um dezentrale Netzwerke, die auf der Blockchain-Technologie basieren - einem verteilten Hauptbuch, das von einem verteilten Computernetzwerk verwaltet wird. Ein entscheidendes Merkmal von Kryptowährungen ist, dass sie im Allgemeinen nicht von einer zentralen Behörde ausgegeben werden, was sie theoretisch immun gegen staatliche Eingriffe oder Manipulationen macht.',
            list1: 'Kryptowährungen sind eine Form von digitalen Vermögenswerten, die auf einem Netzwerk basieren, das auf eine große Anzahl von Computern verteilt ist. Diese dezentrale Struktur ermöglicht es ihnen, außerhalb der Kontrolle von Regierungen und zentralen Behörden zu existieren.',
            list2: 'Experten glauben, dass die Blockchain und die damit verbundenen Technologien die Arbeit vieler Branchen, einschließlich Finanzen und Recht, stören.',
            list3: 'Zu den Vorteilen von Kryptowährungen gehören billigere und schnellere Geldtransfers und dezentralisierte Systeme, die nicht an einem einzigen Punkt zusammenbrechen',
            list4: 'Zu den Nachteilen von Kryptowährungen gehören die Volatilität ihres Preises, der hohe Energieverbrauch beim Mining und ihre Verwendung für kriminelle Aktivitäten.',
            understanding: '// Kryptowährungen Verstehen',
            textUnderstanding1: 'Kryptowährungen sind digitale oder virtuelle Währungen, die auf kryptografischen Systemen basieren. Sie ermöglichen sichere Online-Zahlungen ohne den Einsatz von dritten Vermittler. Krypto" bezieht sich auf die verschiedenen Verschlüsselungsalgorithmen und kryptografischen Techniken, die diese Datensätze schützen, wie z. B. die elliptische Kurvenverschlüsselung, öffentliche und private Schlüsselpaare und Hashing-Funktionen.',
            textUnderstanding2: 'Kryptowährungen können geschürft oder an Kryptowährungsbörsen gekauft werden. Nicht auf allen E-Commerce-Websites können Sie mit Kryptowährungen einkaufen. Tatsächlich werden Kryptowährungen, selbst solche, die so populär sind wie Bitcoin, kaum für Transaktionen im Einzelhandel verwendet. Der rasante Anstieg des Wertes von Kryptowährungen hat sie jedoch zu beliebten Handelsinstrumenten gemacht. In begrenztem Umfang werden sie auch für grenzüberschreitende Überweisungen genutzt.',
            blockchain: '// Blockchain',
            textBlockchain1: 'Das Herzstück der Attraktivität und Funktionalität von Bitcoin und anderen Kryptowährungen ist die Blockchain-Technologie. Wie der Name schon sagt, handelt es sich bei der Blockchain um eine Reihe von miteinander verbundenen Blöcken oder ein Online-Register. Jeder Block enthält eine Reihe von Transaktionen, die von jedem Teilnehmer des Netzes unabhängig voneinander überprüft wurden. Jeder neu erstellte Block muss von jedem Knoten überprüft werden, bevor er validiert wird, so dass es praktisch unmöglich ist, den Transaktionsverlauf zu manipulieren. Der Inhalt des Online-Registers muss vom gesamten Netzwerk des einzelnen Knotens oder Computers, der die Kopie des Registers besitzt, gebilligt werden.',
            textBlockchain2: 'Experten sind der Meinung, dass die Blockchain-Technologie für viele Branchen, z. B. für Lieferketten und Prozesse wie Online-Abstimmungen und Crowdfunding, von Nutzen sein kann. Finanzinstitute wie JPMorgan Chase & Co. (JPM) testen den Einsatz der Blockchain-Technologie, um die Transaktionskosten zu senken und die Zahlungsabwicklung zu optimieren.',
            table: 'KRYPTOWÄHRUNGEN, DIE AUF UNSERER PLATTFORM VERFÜGBAR SIND'
        },
        metals: {
            descHead: 'The periodic table represents the earth\'s known chemical elements, and some of them make excellent investments. Rare earth metals, along with a selection of elements known as base and precious metals, provide today\'s investors and active traders with a variety of trading opportunities. They\'re also often formed into ingots for physical purchases.',
            list1: 'Investors can participate in the base metals market by buying shares of companies like U.S. Steel, futures, options, and various ETFs.',
        ...
        index: {
            descHead1: 'A market index is a hypothetical portfolio of investment holdings that represents a segment of the financial market. The calculation of the index value comes from the prices of the underlying holdings. Some indexes have values based on market-cap weighting, revenue-weighting, float-weighting, and fundamental-weighting. Weighting is a method of adjusting the individual impact of items in an index.',
            descHead2: 'Investors follow different market indexes to gauge market movements. The three most popular stock indexes for tracking the performance of the U.S. market are the Dow Jones Industrial Average (DJIA), S&P 500 Index and Nasdaq Composite Index. In the bond market, Bloomberg is a leading provider of market indexes with the Bloomberg U.S. Aggregate Bond Index serving as one of the most popular proxies for U.S. bonds1 Investors cannot invest directly in an index, so these portfolios are used broadly as benchmarks or for developing index funds.',
            list1: 'Market indexes provide a broad representative portfolio of investment holdings.',
            list2: 'Methodologies for constructing individual indexes vary but nearly all calculations are based on weighted average mathematics.',
            list3: 'Indexes are used as benchmarks to gauge the movement and performance of market segments.',
            list4: 'Investors use indexes as a basis for portfolio or passive index investing.',
        ...
        nft: {
            descHead1: 'Nicht austauschbare Token (NFTs) sind kryptografische Vermögenswerte auf einer Blockchain mit eindeutigen Identifikationscodes und Metadaten, die sie voneinander unterscheiden. Anders als Kryptowährungen können sie nicht gehandelt oder gegen einen Gegenwert getauscht werden. Dies unterscheidet sie von austauschbaren Token, wie z. B. Kryptowährungen, die untereinander identisch sind und daher als Vehikel für kommerzielle Transaktionen dienen können.',
            descHead2: 'Die individuelle Gestaltung jedes NFT hat das Potenzial für mehrere Anwendungen. Sie sind zum Beispiel ein ideales Mittel für die digitale Darstellung von physischen Werten wie Immobilien und Kunstwerken. Da sie auf der Blockchain basieren, können NFTs auch dazu dienen, Vermittler auszuschalten und Künstler mit dem Publikum zu verbinden oder die Identität zu verwalten. NFTs können Zwischenhändler ausschalten, Transaktionen vereinfachen und neue Märkte schaffen.',
            descHead3: 'Ein Großteil des heutigen NFT-Marktes konzentriert sich auf Sammlerstücke wie digitale Kunst, Sportkarten und Raritäten. Der vielleicht beliebteste Markt ist NBA Top Shot, ein Ort, an dem man unspielbare NBA-Token-Momente in Form von digitalen Karten sammeln kann. Einige dieser Karten sind für Millionen von Dollar verkauft worden. Twitter (TWTR) Chef Jack Dorsey twitterte kürzlich einen Link zu einer tokenisierten Version des allerersten Tweets, in dem er schrieb: "Just setting up my twttr". Die NFT-Version des allerersten Tweets wurde für mehr als 2,9 Millionen Dollar verkauft.',
            list1: 'NFTs sind einzigartige kryptografische Token, die auf der Blockchain existieren und nicht repliziert werden können.',
            list2: 'NFTs können reale Objekte, wie Kunstwerke und Immobilien, darstellen.',
            list3: 'Die "Tokenisierung" dieser realen Sachwerte macht deren Kauf, Verkauf und Handel effizienter und verringert gleichzeitig die Wahrscheinlichkeit von Betrug',
            list4: 'NFTs können auch die Identität einer Person, Eigentumsrechte und mehr darstellen.',
            understanding: '// NFT verstehen',
            textUnderstanding1: 'Wie physisches Geld sind Kryptowährungen fungibel, d. h. sie können umgetauscht oder gegeneinander ausgetauscht werden. Zum Beispiel ist ein Bitcoin immer gleich viel wert wie ein anderer Bitcoin. In ähnlicher Weise ist eine Einheit Äther immer gleich einer anderen Einheit. Diese Eigenschaft der Austauschbarkeit macht Kryptowährungen zu einem sicheren Transaktionsmittel in der digitalen Wirtschaft.',
            textUnderstanding2: 'NFTs verändern das Paradigma von Kryptowährungen, indem sie jeden Token einzigartig und unersetzlich machen, wodurch es unmöglich wird, dass ein nicht austauschbarer Token einem anderen gleichwertig ist. Sie sind eine digitale Darstellung von Vermögenswerten und wurden mit digitalen Reisepässen verglichen, da jeder Token eine eindeutige, nicht übertragbare Kennung enthält, die ihn von anderen Token unterscheidet. Sie sind auch erweiterbar, d. h. Sie können eine NFT mit einer anderen kombinieren, um eine dritte, einzigartige NFT zu "erzeugen".',
            textUnderstanding3: 'Wie Bitcoin enthalten auch NFTs Eigentümerdaten, um die Identifizierung und den Transfer zwischen Token-Inhabern zu erleichtern. Inhaber können einer NFT auch Metadaten oder Attribute in Bezug auf ein Asset hinzufügen. So können beispielsweise Wertmarken, die Kaffeebohnen repräsentieren, als fair gehandelt eingestuft werden. Oder Künstler können ihre digitalen Kunstwerke mit ihrer eigenen Signatur in den Metadaten signieren.',
            textUnderstanding4: 'NFT hat sich aus dem ERC-721-Standard entwickelt. Der ERC-721-Standard wurde von denselben Personen entwickelt, die auch für den ERC-20-Smart-Contract verantwortlich waren, und definiert die Mindestschnittstelle - Eigentumsangaben, Sicherheit und Metadaten, die für den Austausch und die Verteilung von Gaming-Token erforderlich sind. Der ERC-1155-Standard führt das Konzept weiter, indem er die für NFT erforderlichen Transaktions- und Speicherkosten reduziert und mehrere Arten von nicht austauschbaren Token in einem einzigen Vertrag zusammenfasst.',
            textUnderstanding5: 'Das vielleicht bekannteste Beispiel für den Einsatz von NFT sind Kryptokätzchen (cryptokitties). Die im November 2017 eingeführten Kryptokätzchen (cryptokitties) sind digitale Abbildungen von Katzen mit einer einzigartigen Identität auf der Ethereum-Blockchain. Jedes Kätzchen ist einzigartig und hat seinen eigenen Preis im Ether. Sie vermehren sich untereinander und bringen neue Nachkommen hervor, die andere Eigenschaften und einen anderen Wert haben als ihre Eltern.',
            textUnderstanding6: 'Innerhalb weniger Wochen nach dem Start gewannen die Kryptokätzchen (cryptokitties) Bewunderer, die 20 Millionen Dollar in Ether ausgaben, um sie zu kaufen, zu füttern und aufzuziehen. Einige Enthusiasten haben sogar bis zu 100.000 Dollar für diesen Zweck ausgegeben. In jüngster Zeit hat der Bored Ape Yacht Club wegen seiner hohen Preise, seiner Berühmtheit folgen und der öffentlichkeitswirksamen Diebstähle einiger der 10.000 NFTs kontroverse Aufmerksamkeit auf sich gezogen.',
            textUnderstanding7: 'Während die Fälle von Kryptokätzchen (cryptokitties) und dem Bored Ape Yacht Club trivial erscheinen mögen, haben andere ernstere Auswirkungen auf die Wirtschaft. So wurden NFTs beispielsweise bei Private-Equity-Transaktionen und bei Immobilientransaktionen eingesetzt. Eine Folge der Aufnahme mehrerer Arten von Token in einen Vertrag ist die Möglichkeit, verschiedene Arten von NFTs - von Kunstwerken bis hin zu Immobilien - in einer einzigen Finanztransaktion zu hinterlegen.',
            stock: '// Aktien-CFD-Handel',
            stockText1: 'Bei Investous können Sie mit Differenzkontrakten (CFDs) handeln, bei denen NFT als Basiswert verwendet wird. So können Sie Long- oder Short-Positionen auf die Aktien eines Unternehmens eingehen, ohne diese tatsächlich zu besitzen. Auf diese Weise können Sie auf Aktienkursbewegungen spekulieren, auch wenn Sie keinen Zugang zu einer Börse wie der New Yorker oder Londoner Börse haben. Sie können zum Beispiel IBM-Aktienkontrakte kaufen, wenn Sie glauben, dass der Wert der Aktie steigen wird, oder sie leerverkaufen, wenn Sie glauben, dass der Kurs fallen wird. Das Schöne am CFD-Handel ist, dass Sie auf steigende oder fallende Kurse spekulieren können und gleichzeitig Anspruch auf eine Dividende haben, wenn das Unternehmen eine Ausschüttung an die Aktionäre beschließt. Mit einer langen Liste von Aktien der weltweit größten Unternehmen treten Sie heute Investors bei.',
            table: 'NFT-INDIZES AUF UNSERER PLATTFORM'
        },
        ourPlatform: {
            dash: 'Benutzerdefiniertes Bedienfeld.',
            dashDesc: 'Dies ist die erste Seite, die Sie sehen, nachdem Sie sich bei unserer Plattform angemeldet haben. Auf dieser Seite können Sie alle Ihre Handelsaktivitäten verfolgen: aktueller Kontostand, Gesamtgewinne und -verluste, ROI, Informationen über jedes Ihrer Konten, die Anzahl der gewinnbringenden Aufträge im Vergleich zur Anzahl aller Ihrer Geschäfte, ein Liniendiagramm, das die Entwicklung Ihres Kontostandes im Laufe der Zeit zeigt, und ein Protokoll aller Zeiten, in denen Sie sich angemeldet haben.',
            deposit: 'Einzahlungsseite',
            depositDesc: 'Um mit dem Handel zu beginnen, müssen Sie auf Ihr Konto einzahlen, was Sie auf dieser Seite tun können. Wählen Sie eine der verfügbaren Einzahlungsmethoden, geben Sie den Betrag ein und gehen Sie zum Zahlungssystem, einem von Dritten bereitgestellten Dienst. Sobald Ihre Einzahlung bestätigt ist, erhalten Sie eine Benachrichtigung auf unserer Plattform und können mit der Auftragserteilung beginnen.',
            main: 'Haupthandelsbildschirm',
            mainDesc: 'Hier sehen Sie ein Diagramm des von Ihnen gewählten Vermögenswerts und ein Menü mit Aufträgen, aus dem Sie Aufträge eröffnen können. Jeder von Ihnen eröffnete Handel kann entsprechend Ihrer Strategie fein abgestimmt werden: Sie können Long- und Short-Trades platzieren, bei Bedarf Limit-Orders setzen, eine von drei Umwandlungen wählen und Stop-Loss- und Take-Profit-Levels festlegen. Der Trendindikator hilft Ihnen, die richtige Entscheidung zu treffen, und der Gewinnrechner unterstützt Sie bei der Planung Ihrer Risiken und zukünftigen Gewinne.',
            widgets: 'Widgets',
            widgetsDesc: 'Der Hauptbildschirm für den Handel ist voll von zusätzlichen Funktionen, die für Ihren Komfort entwickelt wurden. Auf der linken Seite sehen Sie ein Widget-Panel mit Marktübersicht, Wirtschaftskalender, Marktnachrichten und Details zu Ihren offenen und geschlossenen Geschäften. Diese Geschäfte werden auch im Auftragspaneel am unteren Rand des Bildschirms angezeigt.',
        },
        accountTypes: {
            desc: 'Für unsere treuen Kunden stehen verschiedene Kontotypen zur Verfügung. Je mehr Sie handeln, desto bequemer sind Ihre Optionen.',
            btnText: 'Konto eröffnen',
            minVolume: 'Mindestvolumen',
            maxVolume: 'Maximale volumen',
            lotSize: 'Los-Größe',
            main: 'Haupt',
            bronze: 'Bronze',
            silver: 'Silber',
        ...
        trading: {
            descHead1: "Beim Momentum-Trading, einer Art des technischen Handels, achtet ein Händler auf Anzeichen dafür, dass eine Aktie kurz vor einem Ausbruch steht, d. h. dass sie über einen ausreichenden Zeitraum hinweg eine signifikante Kursbewegung in eine Richtung bei hohem Volumen vollzieht, die einen Gewinn bringen könnte. Durch die Beobachtung der Momentum-Linie hat der Momentum-Händler bereits eine technische Analyse durchgeführt, indem er die Aktiencharts auf Anzeichen für einen Ausbruch untersucht hat.",
            descHead2: 'Die technischen Indikatoren, die beim Momentum-Trading verwendet werden, sind nur die Spitze des Eisbergs; sie sind nur ein kleiner Ausschnitt aus der breiten Palette von Chart- und Grafikmustern, die dem technischen Trader zur Verfügung stehen.',
            descHead3: 'N\n' +
                'Neueinsteiger können mit jeder dieser Techniken experimentieren, sollten sich aber letztlich auf eine einzige Nische festlegen, die ihren Kenntnissen und Erfahrungen im Bereich der Geldanlage entspricht und zu der sie motiviert sind, weitere Nachforschungen anzustellen, sich weiterzubilden und zu üben. Jedem dieser Stile sind ganze Lehrbücher gewidmet, obwohl aus vielen Titeln wie " Tageshandel online" oder "Einstieg in den elektronischen Tageshandel" nicht klar hervorgeht, welche Art des Handels sie vertreten.',
            different: '// Verschiedene Handelsarten',
            differentDesc: 'Bevor wir uns auf den technischen Handel konzentrieren, hier ein Überblick über die wichtigsten Arten des Aktienhandels:',
            listTitle1: 'Scalping:',
            list1: 'Ein Scalper ist jemand, der Dutzende oder Hunderte von Geschäften pro Tag tätigt und versucht, mit jedem Handel einen kleinen Gewinn zu erzielen, indem er die Spanne zwischen Angebot und Nachfrage nutzt.',
            listTitle2: 'Momentum-Handel:',
            list2: 'Momentum-Händler suchen nach Aktien, die sich bei hohem Volumen deutlich in eine Richtung bewegen. Diese Händler versuchen, mit dem Momentum den gewünschten Gewinn zu erzielen.',
            listTitle3: 'Technischer Handel:',
            list3: 'Technische Trader konzentrieren sich auf Diagramme und Schaubilder. Sie beobachten Linien in Aktien- oder Indexdiagrammen auf Anzeichen von Konvergenz oder Divergenz, die auf Kauf- oder Verkaufssignale hindeuten könnten.',
            listTitle4: 'Fundamentaler Handel:',
            list4: 'Fundamentalisten handeln mit Unternehmen auf der Grundlage der Fundamentalanalyse, bei der Unternehmensereignisse wie aktuelle oder erwartete Gewinnmeldungen, Aktiensplits, Umstrukturierungen oder Übernahmen untersucht werden.',
            listTitle5: 'Swing-Handel:',
            list5: 'Swing Trader sind Fundamentalhändler, die ihre Positionen länger als einen Tag halten. Die meisten Fundamentalisten sind eigentlich Swing Trader, da Änderungen der Unternehmensfundamentaldaten in der Regel mehrere Tage oder sogar Wochen benötigen, um eine Kursbewegung zu erzeugen, die für den Händler ausreichend ist, um einen angemessenen Gewinn zu erzielen.',
            technical: '// Technischen Handel erforschen',
            technicalDesc1: 'Der technische Handel ist ein breiterer Stil, der nicht unbedingt auf den Handel beschränkt ist. Im Allgemeinen verwendet ein Techniker historische Muster von Handelsdaten, um vorherzusagen, was mit Aktien in der Zukunft geschehen könnte. Dies ist die gleiche Methode, die auch von Wirtschaftswissenschaftlern und Meteorologen angewandt wird: Man schaut in die Vergangenheit, um einen Einblick in die Zukunft zu erhalten. Wir alle wissen jedoch, wie schlecht Prognosen sein können.',
            technicalDesc2: 'Die Herausforderung bei der technischen Analyse besteht darin, dass es buchstäblich Hunderte von technischen Indikatoren gibt, und dass es keinen einzigen Indikator gibt, der allgemein als besser angesehen wird als jeder einzelne Indikator oder jede Gruppe von Indikatoren, die nur unter bestimmten Umständen anwendbar sein können. Einige technische Indikatoren können für bestimmte Branchen nützlich sein, andere nur für Aktien einer bestimmten Klassifizierung (z. B. Aktien innerhalb einer bestimmten Liquiditätsspanne oder Marktkapitalisierung). Aufgrund der einzigartigen Muster, die hoch gehandelte Aktien im Laufe der Geschichte aufweisen können, sind einige Indikatoren möglicherweise nur für bestimmte Einzelaktien relevant.',
            technicalDesc3: 'Technische Indikatoren sind, ebenso wie Momentum-Indikatoren, kein Allheilmittel für die Entscheidung, wann man kaufen oder verkaufen sollte. Sie sind schlechte Prädiktoren für ein genaues Timing, aber sie sind gut geeignet, um anzuzeigen, welche Aktien für eine weitere Analyse mit solch detaillierten Daten wie dem Level-2-Screening in Frage kommen. Die technische Analyse kann also als Ausgangspunkt betrachtet werden - historische Muster ergeben nicht unbedingt ein genaues Bild der künftigen Entwicklung.',
            technicalDesc4: 'Anstatt zu versuchen, eine erschöpfende Studie aller Indikatoren zu erstellen, die dem technischen Händler zur Verfügung stehen, erörtern wir die gebräuchlichsten Gruppierungen und geben eine allgemeine Einführung in jede. Diese Diskussion beschränkt sich auf Indikatoren, die auf einzelne Aktien anwendbar sind - es gibt viele Indikatoren, die für die Vorhersage eines Index oder einer Branchengruppe nützlich sein können.',
        },
        cfdTrading: {
            descHead1: 'Ein Differenzkontrakt (CFD) ist ein Vertrag zwischen einem Käufer und einem Verkäufer, in dem festgelegt ist, dass der Käufer dem Verkäufer die Differenz zwischen dem aktuellen Wert eines Vermögenswerts und seinem Wert zum Zeitpunkt des Vertragsabschlusses zu zahlen hat. CFDs bieten Händlern und Anlegern die Möglichkeit, von Kursbewegungen zu profitieren, ohne die zugrunde liegenden Vermögenswerte zu besitzen. Der Wert eines CFD-Kontrakts berücksichtigt nicht den zugrundeliegenden Wert des Vermögenswerts, sondern nur die Kursveränderung zwischen Ein- und Ausstieg.',
            descHead2: 'Dies wird durch einen Vertrag zwischen Kunde und Broker erreicht, ohne dass eine Aktien-, Devisen-, Rohstoff- oder Terminbörse genutzt wird. Der Handel mit CFDs bietet mehrere wesentliche Vorteile, die die enorme Beliebtheit dieser Instrumente in den letzten zehn Jahren noch verstärkt haben.',
            list1: 'Ein Differenzkontrakt (CFD) ist eine Vereinbarung zwischen einem Anleger und einem CFD-Broker über den Austausch der Wertdifferenz eines Finanzprodukts zwischen dem Zeitpunkt des Öffnens und des Schließens des Kontrakts.',
            list2: 'A CFD investor never actually owns the underlying asset but instead receives revenue based on the price change of that asset.',
            list3: 'Einige Vorteile von CFDs umfassen den Zugang zu einem Basiswert zu einem niedrigeren Preis als den direkten Kauf eines Vermögenswerts, die Einfachheit der Ausführung, die Möglichkeit von Long- oder Short-Positionen.',
            list4: 'Ein Nachteil von CFDs ist die sofortige Verringerung der Anfangsposition des Anlegers, die sich um die Spread-Größe verringert, wenn Sie in CFDS einsteigen.',
            list5: 'Zu den weiteren CFD-Risiken gehören eine schwache Regulierung der Branche, ein potenzieller Mangel an Liquidität und die Notwendigkeit, eine angemessene Marge einzuhalten.',
            cfds: '// Wie CFDs funktionieren',
            cfdsDesc1: 'Ein Differenzkontrakt (CFD) ist eine Vereinbarung zwischen einem Anleger und einem CFD-Broker über den Austausch der Wertdifferenz eines Finanzprodukts (Wertpapiere oder Derivate) zwischen dem Zeitpunkt, zu dem der Kontrakt eröffnet und geschlossen wird.',
            cfdsDesc2: 'Es handelt sich um eine fortgeschrittene Handelsstrategie, die nur von erfahrenen Händlern genutzt wird. Bei CFDs gibt es keine Lieferung von physischen Waren oder Wertpapieren. Ein CFD-Anleger ist nie Eigentümer des zugrunde liegenden Vermögenswerts, sondern erhält stattdessen Einnahmen auf der Grundlage der Preisänderung dieses Vermögenswerts. Anstatt physisches Gold zu kaufen oder zu verkaufen, kann ein Händler zum Beispiel einfach darauf spekulieren, ob der Goldpreis steigen oder fallen wird.',
            cfdsDesc3: 'Im Wesentlichen können Anleger mit CFDs Wetten darauf abschließen, ob der Preis des zugrunde liegenden Vermögenswerts oder Wertpapiers steigen oder fallen wird oder nicht. Händler können entweder auf eine Aufwärts- oder Abwärtsbewegung wetten. Wenn der Händler, der einen CFD gekauft hat, sieht, dass der Preis des Vermögenswerts steigt, bietet er seinen Bestand zum Verkauf an. Die Nettodifferenz zwischen dem Kauf- und dem Verkaufspreis wird miteinander verrechnet. Die Nettodifferenz, die den Gewinn aus den Geschäften darstellt, wird über das Maklerkonto des Anlegers abgerechnet.',
            cfdsDesc4: 'Ist der Händler hingegen der Meinung, dass der Wert des Vermögenswerts sinken wird, kann er eine Verkaufsposition eröffnen. Um die Position zu schließen, muss der Händler eine Gegenposition kaufen. Die Nettodifferenz des Verlusts wird dann über das Konto des Händlers abgewickelt.',
        },
        technicalAnalysis: {
            technicalAnalysis: '// Was ist Technische Analyse?',
            descHead1: 'Die technische Analyse ist eine Handelsdisziplin, die zur Bewertung von Investitionen und zur Ermittlung von Handelsmöglichkeiten eingesetzt wird, indem statistische Trends aus der Handelsaktivität, wie z. B. Preisbewegungen und Volumen, analysiert werden. Im Gegensatz zur Fundamentalanalyse, die versucht, den Wert eines Wertpapiers anhand von Geschäftsergebnissen wie Umsatz und Gewinn zu bewerten, konzentriert sich die technische Analyse auf die Untersuchung von Preis und Volumen.',
            list1: 'Die technische Analyse ist eine Handelsdisziplin, die zur Bewertung von Investitionen und zur Identifizierung von Handelsmöglichkeiten in Kurstrends und -mustern auf Charts eingesetzt wird.',
            list2: 'Technische Analysten sind der Ansicht, dass frühere Handelsaktivitäten und Kursveränderungen eines Wertpapiers wertvolle Indikatoren für die künftige Kursentwicklung des Wertpapiers sein können.',
            list3: 'Die technische Analyse kann der Fundamentalanalyse gegenübergestellt werden, die sich eher auf die Finanzdaten eines Unternehmens als auf historische Kursmuster oder Aktientrends konzentriert.\n',
            understanding: '// Technische Analyse verstehen',
            textUnderstanding1: 'Mit den Instrumenten der technischen Analyse wird untersucht, wie sich Angebot und Nachfrage bei einem Wertpapier auf Veränderungen von Preis, Volumen und impliziter Volatilität auswirken. Sie geht von der Annahme aus, dass frühere Handelsaktivitäten und Kursveränderungen eines Wertpapiers wertvolle Indikatoren für die künftigen Kursbewegungen des Wertpapiers sein können, wenn sie mit geeigneten Anlage- oder Handelsregeln kombiniert werden.',
            textUnderstanding2: 'Sie wird häufig verwendet, um kurzfristige Handelssignale aus verschiedenen Diagrammwerkzeugen zu generieren, kann aber auch dazu beitragen, die Bewertung der Stärke oder Schwäche eines Wertpapiers im Vergleich zum breiteren Markt oder einem seiner Sektoren zu verbessern. Diese Informationen helfen den Analysten, ihre Gesamtbewertung zu verbessern.',
            textUnderstanding3: 'Die technische Analyse, wie wir sie heute kennen, wurde erstmals von Charles Dow und der Dow-Theorie in den späten 1800er Jahren eingeführt. Mehrere bemerkenswerte Forscher, darunter William P. Hamilton, Robert Rhea, Edson Gould und John Magee, trugen zu den Konzepten der Dow-Theorie bei und bildeten deren Grundlage. Heutzutage umfasst die technische Analyse Hunderte von Mustern und Signalen, die in jahrelanger Forschung entwickelt wurden.',
            using: '// Technische Analyse verwenden',
            textUsing1: 'Professionelle Analysten nutzen die technische Analyse oft in Verbindung mit anderen Formen der Forschung. Privatanleger treffen ihre Entscheidungen möglicherweise ausschließlich auf der Grundlage der Kurscharts eines Wertpapiers und ähnlicher Statistiken, aber praktizierende Aktienanalysten beschränken ihre Untersuchungen selten auf die fundamentale oder technische Analyse allein.',
            textUsing2: 'Die technische Analyse kann auf jedes Wertpapier mit historischen Handelsdaten angewendet werden. Dazu gehören Aktien, Futures, Rohstoffe, festverzinsliche Wertpapiere, Währungen und andere Wertpapiere. Tatsächlich ist die technische Analyse auf den Rohstoff- und Devisenmärkten, wo sich die Händler auf kurzfristige Preisbewegungen konzentrieren, weitaus häufiger anzutreffen.',
            textUsing3: 'Mit der technischen Analyse wird versucht, die Kursentwicklung praktisch aller handelbaren Instrumente vorherzusagen, die im Allgemeinen den Kräften von Angebot und Nachfrage unterliegen, einschließlich Aktien, Anleihen, Futures und Währungspaaren. Manche betrachten die technische Analyse sogar einfach als die Untersuchung der Kräfte von Angebot und Nachfrage, die sich in den Kursbewegungen eines Wertpapiers widerspiegeln.',
            textUsing4: 'Die technische Analyse bezieht sich in der Regel auf Preisänderungen, aber einige Analysten verfolgen auch andere Zahlen als nur den Preis, wie z. B. das Handelsvolumen oder die Zahl der offenen Positionen.',
        },
        fundamentalAnalysis: {
            fundamentalAnalysis: '// Was ist fundamentale Analyse?',
            descHead1: 'Die Fundamentalanalyse (FA) ist eine Methode zur Messung des inneren Wertes eines Wertpapiers durch Untersuchung der damit verbundenen wirtschaftlichen und finanziellen Faktoren. Fundamentalanalysten untersuchen alle Faktoren, die den Wert eines Wertpapiers beeinflussen können, von makroökonomischen Faktoren wie dem Zustand der Wirtschaft und den Bedingungen in der Branche bis hin zu mikroökonomischen Faktoren wie der Effizienz der Unternehmensführung.',
            descHead2: 'Das Ziel ist es, eine Zahl zu ermitteln, die ein Anleger mit dem aktuellen Kurs eines Wertpapiers vergleichen kann, um festzustellen, ob das Wertpapier unter- oder überbewertet ist.',
            descHead3: 'Diese Methode der Aktienanalyse steht im Gegensatz zur technischen Analyse, die durch die Analyse historischer Marktdaten wie Preis und Volumen die Richtung der Kurse vorhersagt.',
            list1: 'Die Fundamentalanalyse ist eine Methode zur Ermittlung des tatsächlichen oder "fairen" Marktwerts einer Aktie.',
            list2: 'Fundamentalanalysten suchen nach Aktien, die derzeit zu Preisen gehandelt werden, die über oder unter ihrem tatsächlichen Wert liegen.',
            list3: 'Liegt der faire Marktwert über dem Börsenkurs, gilt die Aktie als unterbewertet und es wird eine Kaufempfehlung ausgegeben.',
            list4: 'Im Gegensatz dazu ignorieren die technischen Analysten die Fundamentaldaten und untersuchen stattdessen die historischen Kurstrends der Aktie.',
            understanding: '// Die Fundamentalanalyse verstehen',
            textUnderstanding1: 'Bei jeder Aktienanalyse wird versucht festzustellen, ob ein Wertpapier auf dem breiteren Markt richtig bewertet ist. Die Fundamentalanalyse wird in der Regel aus einer Makro- bis Mikro-Perspektive durchgeführt, um Wertpapiere zu ermitteln, die vom Markt nicht korrekt bewertet werden.',
            textUnderstanding2: 'Analysten untersuchen in der Regel zunächst die allgemeine Wirtschaftslage und dann die Stärke der jeweiligen Branche, bevor sie sich auf die Leistung einzelner Unternehmen konzentrieren, um einen fairen Marktwert für die Aktie zu ermitteln.',
            textUnderstanding3: 'Die Fundamentalanalyse verwendet öffentliche Daten, um den Wert einer Aktie oder eines anderen Wertpapiers zu bewerten. So kann ein Anleger beispielsweise eine Fundamentalanalyse für den Wert einer Anleihe durchführen, indem er wirtschaftliche Faktoren wie Zinssätze und den allgemeinen Zustand der Wirtschaft betrachtet und dann Informationen über den Emittenten der Anleihe, wie etwa mögliche Änderungen seines Kreditratings, untersucht.',
            textUnderstanding4: 'Bei Aktien werden bei der Fundamentalanalyse Einnahmen, Gewinne, künftiges Wachstum, Eigenkapitalrendite, Gewinnspannen und andere Daten verwendet, um den zugrunde liegenden Wert eines Unternehmens und sein Potenzial für künftiges Wachstum zu ermitteln. Alle diese Daten sind in den Jahresabschlüssen eines Unternehmens verfügbar (mehr dazu weiter unten).',
            analysis: '// Investieren und Fundamentalanalyse',
            textAnalysis1: 'Ein Analyst arbeitet an der Erstellung eines Modells zur Bestimmung des geschätzten Wertes des Aktienkurses eines Unternehmens auf der Grundlage öffentlich zugänglicher Daten. Dieser Wert ist nur eine Schätzung, die fundierte Meinung des Analysten, was der Aktienkurs des Unternehmens im Vergleich zum aktuellen Marktpreis wert sein sollte. Einige Analysten bezeichnen ihren geschätzten Preis als den inneren Wert des Unternehmens.',
            textAnalysis2: 'Geht ein Analyst davon aus, dass der Wert der Aktie deutlich über dem aktuellen Marktpreis liegen sollte, kann er eine Kauf- oder Übergewichtung für die Aktie veröffentlichen. Dies dient als Empfehlung für Anleger, die diesem Analysten folgen. Berechnet der Analyst einen niedrigeren inneren Wert als den aktuellen Marktpreis, gilt die Aktie als überbewertet und es wird eine Verkaufs- oder Untergewichtung-Empfehlung ausgesprochen.',
            textAnalysis3: 'Anleger, die diesen Empfehlungen folgen, gehen davon aus, dass sie Aktien mit günstigen Empfehlungen kaufen können, da solche Aktien eine höhere Wahrscheinlichkeit haben sollten, im Laufe der Zeit zu steigen. Umgekehrt wird erwartet, dass Aktien mit ungünstigen Bewertungen mit höherer Wahrscheinlichkeit im Kurs fallen werden. Solche Aktien sind Kandidaten, die aus bestehenden Portfolios entfernt oder als "Short"-Positionen hinzugefügt werden können.',
            textAnalysis4: 'Diese Methode der Aktienanalyse gilt als das Gegenteil der technischen Analyse, die durch die Analyse historischer Marktdaten wie Preis und Volumen die Richtung der Kurse vorhersagt. Wer mehr über die Fundamentalanalyse und andere Finanzthemen erfahren möchte, sollte die Teilnahme an einem der besten Kurse für Anleger in Erwägung ziehen, die derzeit verfügbar sind.',
        },
        riskManagement: {
            riskManagement: '// Was ist Risikomanagement?',
            descHead1: 'In der Finanzwelt ist Risikomanagement der Prozess der Identifizierung, Analyse und Akzeptanz oder Abschwächung von Unsicherheiten bei Investitionsentscheidungen. Das Risikomanagement besteht im Wesentlichen darin, dass ein Anleger oder Fondsmanager das Verlustpotenzial einer Investition analysiert und zu quantifizieren versucht (z. B. moralisches Risiko) und dann angesichts der Anlageziele und der Risikotoleranz des Fonds die geeigneten Maßnahmen ergreift (oder nicht ergreift).',
            descHead2: 'Das Risiko ist untrennbar mit der Rendite verbunden. Jede Anlage birgt ein gewisses Risiko, das im Falle einer US-Staatsanleihe gegen Null tendiert, während es bei Aktien aus Schwellenländern oder Immobilien in hochinflationären Märkten sehr hoch ist. Das Risiko lässt sich sowohl in absoluten als auch in relativen Werten quantifizieren. Ein solides Verständnis des Risikos in seinen verschiedenen Formen kann den Anlegern helfen, die Chancen, Kompromisse und Kosten, die mit verschiedenen Investitionsansätzen verbunden sind, besser zu verstehen.',
            list1: 'Risikomanagement ist der Prozess der Identifizierung, Analyse und Akzeptanz oder Abschwächung von Unsicherheiten bei Investitionsentscheidungen.',
            list2: 'Das Risiko ist in der Welt der Investitionen untrennbar mit der Rendite verbunden.',
            list3: 'Es gibt eine Reihe von Methoden zur Risikobestimmung; eine der gängigsten ist die Standardabweichung, ein statistisches Maß für die Streuung um eine zentrale Tendenz.',
            list4: 'Beta, auch bekannt als Marktrisiko, ist ein Maß für die Volatilität oder das systematische Risiko einer einzelnen Aktie im Vergleich zum Gesamtmarkt.',
            list5: 'Alpha ist ein Maß für die Überschussrendite; Geldverwalter, die aktive Strategien anwenden, um den Markt zu schlagen, unterliegen dem Alpha-Risiko.',
            understanding: '// Risikomanagement verstehen',
            textUnderstanding1: 'Risikomanagement findet überall im Finanzbereich statt. Es kommt vor, wenn ein Anleger US-Staatsanleihen gegenüber Unternehmensanleihen bevorzugt, wenn ein Fondsmanager sein Währungsrisiko mit Währungsderivaten absichert und wenn eine Bank die Kreditwürdigkeit einer Person prüft, bevor sie ihr eine persönliche Kreditlinie gewährt. Börsenmakler setzen Finanzinstrumente wie Optionen und Termingeschäfte ein, und Vermögensverwalter verwenden Strategien wie Portfoliodiversifizierung, Vermögensaufteilung und Positionsgröße, um das Risiko zu mindern oder effektiv zu steuern.',
            textUnderstanding2: 'Ein unzureichendes Risikomanagement kann schwerwiegende Folgen für Unternehmen, Einzelpersonen und die Wirtschaft haben. So war beispielsweise der Zusammenbruch der Subprime-Hypotheken im Jahr 2007, der zur Auslösung der Großen Rezession beitrug, auf schlechte Risikomanagement-Entscheidungen zurückzuführen, etwa von Kreditgebern, die Hypotheken an Personen mit schlechter Bonität vergaben, von Wertpapierfirmen, die diese Hypotheken kauften, verpackten und weiterverkauften, und von Fonds, die übermäßig in die neu verpackten, aber immer noch riskanten hypothekarisch gesicherten Wertpapiere (MBS) investierten.',
            risk: '// Wie funktioniert Risikomanagement?',
            textRisk1: 'Wir neigen dazu, an "Risiko" überwiegend negativ zu denken. In der Welt der Investitionen ist das Risiko jedoch notwendig und untrennbar mit den gewünschten Ergebnissen verbunden.',
            textRisk2: 'Eine gängige Definition des Anlagerisikos ist eine Abweichung von einem erwarteten Ergebnis. Wir können diese Abweichung in absoluten Zahlen oder relativ zu einem anderen Wert, z. B. einer Marktbenchmark, ausdrücken.',
            textRisk3: 'Obwohl diese Abweichung positiv oder negativ sein kann, stimmen Anlageexperten normalerweise der Idee zu, dass eine solche Abweichung ein gewisses Maß an erwartetem Ergebnis für Ihre Investition impliziert. Um höhere Renditen zu erzielen, muss man also das größere Risiko in Kauf nehmen. Es ist auch eine allgemein akzeptierte Vorstellung, dass ein erhöhtes Risiko in Form einer erhöhten Volatilität auftritt. Obwohl Investmentfachleute ständig nach Wegen suchen und manchmal Wege finden, diese Volatilität zu reduzieren, gibt es unter ihnen keine eindeutige Meinung darüber, wie dies am besten zu erreichen ist.',
            textRisk4: 'Welche Volatilität ein Anleger tolerieren sollte, hängt vollständig von seiner Risikotoleranz und im Fall eines Anlageprofis davon ab, wie tolerant seine Anlageziele sind. Eine der am häufigsten verwendeten absoluten Risikokennzahlen ist die Standardabweichung, ein statistisches Maß für die Streuung um eine zentrale Tendenz. Man betrachtet die durchschnittliche Rendite einer Anlage und ermittelt dann ihre durchschnittliche Standardabweichung über denselben Zeitraum. Normalverteilungen (die bekannte glockenförmige Kurve) besagen, dass die erwartete Rendite einer Anlage in 67 % der Fälle um eine Standardabweichung vom Durchschnitt und in 95 % der Fälle um zwei Standardabweichungen vom Durchschnitt abweichen wird. Dies hilft den Anlegern, das Risiko numerisch zu bewerten. Wenn sie glauben, dass sie das Risiko finanziell und emotional verkraften können, investieren sie.',
        },
        privacy: {
            descHead1: 'Diese Datenschutzpolitik regelt die Sammlung, Verwendung, Speicherung und Weitergabe von Informationen, die von Benutzern ("die Benutzer", "der Benutzer") der cryptowallst.co-Website ("Website") gesammelt werden, durch CryptoWallSt. Diese Datenschutzpolitik gilt für die Website und alle vom Unternehmen angebotenen Produkte und Dienstleistungen.',
            personal: '// Informationen zur persönlichen Identifizierung',
            textPersonal: 'Wir können personenbezogene Daten von Benutzern auf verschiedene Weise erfassen, unter anderem, aber nicht ausschließlich, wenn Benutzer die Website besuchen, sich auf der Website registrieren oder sich für einen Newsletter anmelden, sowie in Verbindung mit anderen Aktivitäten, Dienstleistungen, Funktionen oder Ressourcen, die wir auf der Website anbieten. Die Benutzer können nach ihrem Namen, ihrer E-Mail-Adresse, ihrer Postanschrift, ihrer Telefonnummer und gegebenenfalls nach ihren Kreditkartendaten gefragt werden.',
            user: '// Die Benutzer können die Website jedoch anonym besuchen',
            textUser: 'Wir sammeln persönliche Identifikationsdaten von Benutzern nur dann, wenn sie uns diese Informationen freiwillig zur Verfügung stellen. Die Benutzer können sich jederzeit weigern, persönliche Identifikationsdaten anzugeben, allerdings kann dies dazu führen, dass sie an bestimmten Aktivitäten im Zusammenhang mit der Website nicht teilnehmen können.',
            nonPeronal: '// Nicht-personenbezogene Identifikationsdaten',
            textNonPeronal: 'Wir können nicht-personenbezogene Identifikationsdaten über Benutzer sammeln, wenn sie mit unserer Website interagieren. Zu den nicht personenbezogenen Identifizierungsdaten gehören der Name des Browsers, die Art des Computers und technische Informationen darüber, wie die Benutzer eine Verbindung zu unserer Website herstellen, wie z. B. das verwendete Betriebssystem und der verwendete Internetdienstanbieter, sowie andere ähnliche Informationen.',
            web: '// Webbrowser-Cookies',
            textWeb: 'Unsere Website kann "Cookies" verwenden, um die Benutzererfahrung zu verbessern. Der Webbrowser des Benutzers legt "Cookies" auf seiner Festplatte ab, um die Daten zu speichern und manchmal auch, um Informationen über ihn zu erhalten. Der Nutzer kann seinen Webbrowser so einstellen, dass er die Verwendung von Cookies ablehnt oder dass er vor dem Senden von Cookies gewarnt wird. In diesem Fall ist zu beachten, dass einige Teile der Website möglicherweise nicht ordnungsgemäß funktionieren.',
            use: '// Wie wir die gesammelten Informationen verwenden',
            textUse: 'Wir erfassen und verwenden Ihre personenbezogenen Daten für die folgenden Zwecke:\n' +
                '- Zur Verbesserung unseres Kundendienstes. Ihre Informationen helfen uns, besser auf Ihre Bedürfnisse in Bezug auf Kundendienst und Support zu reagieren.\n' +
                '- Um das Nutzererlebnis zu personalisieren. Wir können Informationen in der Gesamtheit verwenden, um zu verstehen, wie unsere Benutzer als Gruppe die auf unserer Website angebotenen Dienste und Ressourcen nutzen.\n' +
                '- Um unsere Website zu verbessern. Wir sind ständig bestrebt, das Angebot unserer Website auf der Grundlage der Informationen und Rückmeldungen, die wir von Ihnen erhalten, zu verbessern.\n' +
                '- Zur Bearbeitung von Transaktionen. Wir können die Informationen, die Nutzer bei der Aufgabe einer Bestellung über sich selbst angeben, nur zur Bearbeitung dieser Bestellung verwenden. Wir geben diese Informationen nicht an Dritte weiter, es sei denn, dies ist für die Erbringung der Dienstleistung erforderlich.\n' +
                '- Zur Verwaltung von Wettbewerben, Werbeaktionen, Umfragen oder anderen Funktionen der Website.\n' +
                '- Um den Nutzern Informationen zu senden, denen sie zugestimmt haben, über Themen, die unserer Meinung nach für sie von Interesse sind.\n' +
                '- Um gelegentlich E-Mails zu versenden. Die von den Nutzern für die Auftragsabwicklung angegebene E-Mail-Adresse wird ausschließlich für die Zusendung von Informationen und Aktualisierungen in Bezug auf ihre Bestellung verwendet. Sie können auch verwendet werden, um auf ihre Anfragen und/oder andere Ersuchen oder Fragen zu antworten. Wenn der Benutzer sich in unsere Mailingliste einträgt, erhält er E-Mails, die unsere Neuigkeiten, Aktualisierungen, Informationen über relevante Produkte oder Dienstleistungen usw. enthalten können. Wenn der Nutzer zu irgendeinem Zeitpunkt den Erhalt zukünftiger E-Mails abbestellen möchte, finden sich am Ende jeder E-Mail detaillierte Anweisungen zur Abbestellung, oder der Benutzer kann uns über unsere Website kontaktieren.',
            protect: '// Wie wir Ihre Daten schützen',
            textProtect: 'Wir setzen angemessene Verfahren zur Datenerfassung, -speicherung und -verarbeitung sowie Sicherheitsmaßnahmen ein, um die Benutzer vor unbefugtem Zugriff, Veränderung, Offenlegung oder Zerstörung ihrer persönlichen Daten, ihres Benutzernamens, ihres Passworts, ihrer Transaktionsdaten und der auf unserer Website gespeicherten Daten zu schützen. Der Austausch sensibler und privater Daten zwischen der Website und ihren Benutzern erfolgt über einen sicheren SSL-Kommunikationskanal, der verschlüsselt und durch digitale Signaturen geschützt ist.',
            compliance: '// Einhaltung der Anforderungen zum Schutz der Privatsphäre von Kindern im Internet',
            textCompliance: 'Der Schutz der Privatsphäre von sehr jungen Menschen ist besonders wichtig. Aus diesem Grund sammeln oder speichern wir auf unserer Website niemals Informationen von Personen, von denen wir wissen, dass sie unter 18 Jahre alt sind, und kein Teil unserer Website ist so aufgebaut, dass er Personen unter 18 Jahren anspricht.',
            changes: '// Änderungen an dieser Datenschutzpolitik',
            textChanges: 'Wir können diese Datenschutzpolitik jederzeit nach eigenem Ermessen aktualisieren. Wenn wir dies tun, wird das Datum der Aktualisierung am unteren Rand dieser Seite angegeben. Wir empfehlen den Benutzern, diese Seite regelmäßig auf Änderungen zu überprüfen, damit sie wissen, wie wir die von uns erfassten persönlichen Daten schützen. Sie erkennen an und stimmen zu, dass es in Ihrer Verantwortung liegt, diese Datenschutzrichtlinie regelmäßig zu überprüfen und sich mit etwaigen Änderungen vertraut zu machen.',
            acceptance: '//  Ihre Zustimmung zu diesen Bedingungen und Konditionen',
            textAcceptance: 'Durch die Nutzung dieser Website erklären Sie Ihr Einverständnis mit dieser Politik und den Nutzungsbedingungen. Wenn Sie mit dieser Politik nicht einverstanden sind, nutzen Sie die Website bitte nicht. Ihre fortgesetzte Nutzung der Website nach der Veröffentlichung von Änderungen an dieser Richtlinie gilt als Ihre Zustimmung zu diesen Änderungen.',
            contacting: '// Kontakt mit uns',
            textContacting: 'Wenn Sie Fragen zu dieser Datenschutzpolitik, zu den Praktiken dieser Websitenutzung oder zu Ihrem Umgang mit dieser Website haben, wenden Sie sich bitte an uns, indem Sie die im Abschnitt "Kontakt" auf der Website angegebenen Details verwenden.',
        },
        disclaimer: {
            descHead: 'Der Handel mit Vermögenswerten wie Kryptowährungen, mit oder ohne Marge, ist hoch riskant, kann einige oder alle Ihre Anlagen einem erheblichen Risiko aussetzen und ist möglicherweise nicht für alle Anleger geeignet.',
            disclosure: '// Risiko-Offenlegung',
            textDisclosure: 'Der Handel und die Ausführung von Transaktionen, die den in diesem Disclaimer beschriebenen und/oder sich daraus ergebenden Transaktionen ähnlich sind, mit oder ohne Einsatz von Leverage oder Margin, ist ein spekulativer Handel mit hohem Risiko. Sie sollten sorgfältig und ernsthaft abwägen, ob diese Art von Finanztätigkeit für Ihre Bedürfnisse, Ihre finanziellen Mittel und Ihre persönlichen Umstände geeignet ist. Da das Risiko, einen Teil oder das gesamte investierte Kapital innerhalb eines relativ kurzen Zeitraums zu verlieren, hoch ist, empfehlen wir Ihnen, nur Gelder zu verwenden, die Sie für hochriskante spekulative Geschäfte vorgesehen haben. Achten Sie insbesondere auf die folgenden Punkte:',
            currency: '// Währungsrisiken',
            textCurrency: 'Schwankungen auf den Kryptowährungs- und Währungsmärkten treten oft abrupt auf, ohne dass der Umfang oder die Richtung der Veränderungen oder der Zeitrahmen, in dem sie auftreten, vorhergesagt werden können',
            event: '// Ereignisrisiken',
            textEvent: 'Die Preise können aufgrund von unvorhergesehenen Umständen, Ereignissen oder veränderten Bedingungen schnell schwanken.',
            operational: '// Operative Risiken',
            textOperational: 'Obwohl wir uns nach Kräften bemühen, die Kontinuität der Dienstleistungen zu gewährleisten, können operationelle Risiken wie Störungen der Kommunikation, der Computer, der Netzwerke oder externe Ereignisse zu Verzögerungen bei der Ausführung und Abrechnung von Transaktionen führen. Der Einsatz von elektronischer Handelssoftware birgt Risiken, die mit der Computersoftware, dem Internet, den Kommunikationssystemen und den mit uns verbundenen Schnittstellen verbunden sind. Zu den Risiken gehören unter anderem Hardware-, Software-, Kommunikationsleitungs- und Systemausfälle und/oder fehlerhafte Dateneinspeisungen von externen Datenanbietern. Kein Handelssystem ist frei von zufälligen Fehlern, und es gibt kein System, das einen 100%igen Gewinn garantiert oder nicht von Verlusten betroffen ist.',
            margin: '// Margen-Risiko',
            textMargin1: 'Die Leverage oder Marge beim Kryptowährungshandel wird auf der Grundlage von Sicherheiten in Form eines kleinen Betrags im Verhältnis zum Gesamtbetrag der Transaktion erstellt. Der Handel mit Leverage oder Margin hat zur Folge, dass eine kleine Veränderung der Marktpreise über einen kurzen Zeitraum zu erheblichen Gewinnen oder Verlusten führen kann, die proportional zur Höhe der Margin sind, bis hin zu einem Totalverlust der Margin in einem sehr kurzen Zeitraum.',
            textMargin2: 'Diese Warnung deckt nicht alle möglichen Risiken ab, die mit der Art der beschriebenen und/oder sich aus diesem Haftungsausschluss ergebenden Transaktionen verbunden sind.',
        },
        kyc: {
            descHead1: '%%COMPANY_NAME%% verpflichtet sich zur Einhaltung aller relevanten AML- und Terrorismusfinanzierungsvorschriften und die folgenden Richtlinien basieren auf allgemeinen Anti-Geldwäsche-Prinzipien, Gesetzen, Vorschriften und Richtlinien.',
            descHead2: 'Wir glauben, dass die Einhaltung der AML- und CFT-Vorschriften notwendig ist, um die Integrität der Finanzsysteme zu gewährleisten und zu verhindern, dass unser Unternehmen absichtlich oder unabsichtlich von kriminellen Elementen ausgenutzt wird.',
            descHead3: 'Wir haben Know-Your-Customer (KYC; Kenne Deinen Kunden)-Programme als wesentliches Element unserer Service-, Risikomanagement- und Kontrollverfahren eingeführt. Wir sind nicht nur verpflichtet, unsere Kunden zu identifizieren, sondern auch die Kontobewegungen zu überwachen, um die Transaktionen zu ermitteln, die nicht den normalen oder erwarteten Transaktionen für diesen Kunden oder Kontotyp entsprechen. Das Programm umfasst auch Anforderungen für die Führung von Aufzeichnungen, die Meldung verdächtiger Aktivitäten und AML-Schulungen.\n',
            money: '// Was bedeutet Geldwäsche?',
            textMoney1: 'Geldwäsche umfasst alle Formen des Handels mit oder des Besitzes von kriminellen Vermögenswerten, einschließlich des Besitzes von Erträgen aus einer eigenen Straftat sowie der Erleichterung des Handels mit oder der Übertragung von kriminellen Vermögenswerten auf eine andere Person, einschließlich Erträgen aus Betrug, Bestechung oder Korruption. Zu kriminellem Vermögen gehören Geld, Wertpapiere, materielle und immaterielle Güter, einschließlich der Entgegennahme, des Umgangs mit und des Transfers von Geldern, die aus kriminellen Aktivitäten stammen.',
            textMoney2: 'Vereinfacht dargestellt, umfasst eine wirksame Geldwäscheoperation drei Schritte:',
            textMoney3: 'Die Platzierung von physischen Geldern (z. B. auf einem Bankkonto). Eine vereinfachte Darstellung einer effektiven Geldwäscheoperation umfasst drei Phasen:',
            textMoney4: 'Schichtung. Die Verwendung von Geldern von einem Bankkonto und die Durchführung mehrerer Transaktionen, die den Prüfpfad verwirren und das Geld von seiner Herkunft trennen.',
            textMoney5: 'Integration der gewaschenen Erlöse in die legale Wirtschaft, so dass sie legitim erscheinen und als normale Geschäftsgelder dargestellt werden.',
            textMoney6: 'Im Rahmen dieser Politik umfasst der Begriff der Geldwäsche auch Aktivitäten im Zusammenhang mit der Finanzierung des Terrorismus, einschließlich des Umgangs mit oder des Besitzes von Geldern, die für terroristische Zwecke bestimmt sind, und von Erträgen aus dem Terrorismus.',
            textMoney7: 'Im Umgang mit Kunden sind wir uns der Möglichkeit bewusst, dass Kunden, ihre Gegenparteien oder andere (mit oder ohne Wissen des Kunden) versuchen könnten, mit Hilfe unserer Dienstleistungen Geld zu waschen - durch Schichtung oder Integration.',
            kyc: '// Kenne-deinen-Kunden',
            textKyc1: 'Wir stellen unseren Kunden in der Antragsphase eine Reihe von Fragen, um sie zu verstehen und sicherzustellen, dass der Antragsteller kein Opfer von Finanzkriminalität ist. Von den Kunden werden Unterlagen eingeholt, um die in der Antragsphase gemachten Angaben zu überprüfen. Diese Unterlagen können während des Antragsverfahrens elektronisch überprüft werden.',
            textKyc2: 'Von Zeit zu Zeit bitten wir unsere Kunden auch, die bei der Antragstellung angegebenen persönlichen Daten zu aktualisieren, um sicherzustellen, dass ihre Kundendaten und Informationen auf dem neuesten Stand sind.',
            customer: '// Kundenakzeptanz',
            textCustomer1: 'Wir haben klare Richtlinien und Verfahren für die Annahme von Kunden, einschließlich einer Beschreibung der Arten von Kunden, die ein überdurchschnittliches Risiko darstellen können. Bevor ein potenzieller Kunde akzeptiert wird, werden KYC- und Due-Diligence-Verfahren befolgt und Faktoren wie der Hintergrund des Kunden, sein Herkunftsland, seine öffentliche oder leitende Position, verbundene Konten, Geschäftstätigkeiten oder andere Risikoindikatoren geprüft.',
            textCustomer2: 'Die Durchführung einer Due-Diligence-Prüfung ist notwendig für eine Person, die sehr wohlhabend ist, deren Geldquelle aber unklar ist. Das Geld neuer Kunden wird über eine renommierte Bank überwiesen. Die Banken haben ihre eigenen Verfahren zur Bekämpfung der Geldwäsche. Die Entscheidung über die Aufnahme von Geschäftsbeziehungen mit Hochrisikokunden, wie z. B. politisch exponierten Personen, wird ausschließlich auf der Ebene der Geschäftsleitung getroffen.',
            control: '// Überwachung',
            textControl: 'Wir haben eine Reihe von internen Kontrollen, einschließlich, aber nicht beschränkt auf die Nichtannahme von Bargeld und die Nichtannahme von Einzahlungen und Rücknahmen durch Dritte. Wir akzeptieren keine natürlichen oder juristischen Personen aus Ländern oder Organisationen, gegen die Beschränkungen oder Sanktionen verhängt wurden, als Kunden. Links zu solchen Bewertungen enthalten Websites:\n' +
                '- Australisches Ministerium für auswärtige Angelegenheiten und Handel,\n' +
                '- Konsolidierte Länderlisten,\n' +
                '- US Office of Foreign Assets Control,\n' +
                '- FATF.\n' +
                '\n' +
                'Wir akzeptieren keine US-Bürger.\n' +
                '\n' +
                'Wir akzeptieren keine anonymen Konten und unterhalten keine Beziehungen zu Briefkastenbanken.',
            identification: '// Kundenidentifikation',
            textIdentification1: 'Wir holen alle Informationen ein, die erforderlich sind, um die Identität jedes neuen Kunden sowie den Zweck und die beabsichtigte Art der Geschäftsbeziehung vollständig festzustellen. Umfang und Art der Informationen hängen von der Art des Antragstellers (Privatperson, Unternehmen usw.) und dem geplanten Umfang des Kontos ab.',
            textIdentification2: 'Die Kundenidentifizierung ist ein wichtiges Element der KYC-Standards. Im Sinne dieser Richtlinie gilt als Kunde:\n' +
                '- Die natürliche oder juristische Person, die das Konto führt, oder diejenigen, in deren Auftrag das Konto geführt wird (d. h. die begünstigten Eigentümer);\n' +
                '- Begünstigte von Transaktionen, die von professionellen Vermittlern durchgeführt werden;\n' +
                '- Jede Person oder Einrichtung, die mit einer Finanztransaktion in Verbindung steht, die ein erhebliches Reputations- oder sonstiges Risiko für unser Unternehmen darstellen kann.\n' +
                '\n',
            textIdentification3: 'Die Identifizierung des Kunden muss so schnell wie möglich nach dem ersten Kontakt erfolgen. Wir führen ein systematisches Verfahren zur Identifizierung neuer Kunden durch und gehen erst dann eine Dienstleistungsbeziehung ein, wenn die Identität des neuen Kunden zufriedenstellend überprüft wurde.',
            textIdentification4: 'Wir schenken gebietsfremden Kunden besondere Aufmerksamkeit und wenden keinesfalls Identifizierungsverfahren an, nur weil ein neuer Kunde keine ausreichenden Dokumente und Informationen zur Durchführung von KYC- und Due-Diligence-Verfahren vorlegen kann.',
            textIdentification5: 'Im Rahmen unserer Sorgfaltspflicht gegenüber unseren Kunden müssen wir bestätigen, dass die Identifikationsdaten unserer Kunden während der gesamten Geschäftsbeziehung auf dem neuesten Stand sind und alle erforderlichen Identifikationsmerkmale und Informationen enthalten. Wir überprüfen und überwachen regelmäßig die Gültigkeit und Angemessenheit der von ihr gespeicherten Kundenidentifikationsdaten.',
            textIdentification6: 'Wenn ein Kunde sich weigert oder es versäumt, uns vor Aufnahme einer Geschäftsbeziehung oder während einer einzelnen Transaktion ohne hinreichenden Grund die erforderlichen Dokumente und Informationen zur Identifizierung zur Verfügung zu stellen, werden wir die Vertragsbeziehung nicht fortsetzen oder die Transaktion nicht durchführen und können dies auch dem AML/CFT Supervisor melden. Daraus kann sich der Verdacht ergeben, dass der Kunde in Geldwäsche und Terrorismusfinanzierung verwickelt ist.',
            required: '// Erforderliche Kundeninformationen und Überprüfungsinformationen',
            textRequired1: 'Die folgenden Informationen werden für neue Kunden gesammelt:\n' +
                '- Wahrer vollständiger Name und/oder verwendete Namen;\n' +
                '- Aktuelle ständige Adresse, einschließlich Postleitzahl;\n' +
                '- Geburtsdatum;\n' +
                '- Beruf oder Beschäftigung.',
            textRequired2: 'Namen sollten durch eine Referenz aus einer seriösen Quelle mit einem Foto überprüft werden, wie z. B.:\n' +
                '- Aktueller gültiger vollständiger Reisepass;\n' +
                '- staatlich ausgestellter Lichtbildausweis.',
            textRequired3: 'Wir werden nicht versuchen, festzustellen, ob das Dokument, das der Kunde zur Identifizierung vorgelegt hat, gültig ausgestellt worden ist. Zu Überprüfungszwecken stützen wir uns auf staatlich ausgestellte Ausweise, um die Identität eines Kunden festzustellen. Wir werden jedoch die bereitgestellten Informationen analysieren, um festzustellen, ob es logische Unstimmigkeiten in den erhaltenen Informationen gibt.',
            textRequired4: 'Zusätzlich zur Überprüfung des Namens des Kunden wird die aktuelle ständige Adresse überprüft, indem wir eines der folgenden Dokumente im Original erhalten:\n' +
                '- Kopie einer aktuellen Rechnung eines Versorgungsunternehmens;\n' +
                '- Rechnung der örtlichen Steuerbehörde;\n' +
                '- Kontoauszug;\n' +
                '- Monatsabrechnung einer Kreditkarte.',
            textRequired5: 'Die folgenden Informationen werden für Firmenkunden gesammelt:\n' +
                '- Das Original oder eine beglaubigte Kopie der Gründungsurkunde;\n' +
                '- Satzung, Memorandum und Gesellschaftsvertrag;\n' +
                '- Vorstandsbeschluss zur Durchführung von Transaktionen auf dem Kryptowährungsmarkt und zur Erteilung von Vollmachten an die Personen, die für den Kunden handeln werden;\n' +
                '- Register der Direktoren und Aktionäre;\n' +
                '- Identität der Personen, die mit dem Unternehmen verbunden sind;\n' +
                '- Das Geschäftsprofil des Unternehmens in Bezug auf Art und Umfang der Aktivitäten;',
            textRequired6: 'Unternehmensrecherchen und andere kommerzielle Nachforschungen, um sicherzustellen, dass der Antragsteller nicht aufgelöst, aus dem Handelsregister gestrichen, abgewickelt oder gekündigt wurde oder wird. Wenn sich nach der Eröffnung eines Kontos bei der Gesellschaft Änderungen in der Unternehmensstruktur oder in den Eigentumsverhältnissen ergeben, werden weitere Überprüfungen vorgenommen.',
            textRequired7: 'Die Identitätsprüfung für Firmenkunden zielt auf die Identifizierung ab:\n' +
                '- Das Unternehmen;\n' +
                '- die Geschäftsführer;\n' +
                '- Alle Personen, die ordnungsgemäß zur Führung des Kontos befugt sind;\n' +
                '- Eigentumsverhältnisse;\n' +
                '- Im Falle von Privatunternehmen, die wichtigsten begünstigten Eigentümer;\n' +
                '- Letzte geprüfte Jahresabschlüsse (falls verfügbar).',
            textRequired8: 'Wir müssen die Identität der wirtschaftlichen Eigentümer von Konten überprüfen. Bei juristischen Personen benötigen wir diese Daten und Informationen, um die Eigentums- und Kontrollstruktur des Kunden zu verstehen. Unabhängig von der Art des Kunden (z. B. natürliche oder juristische Person, Personengesellschaft oder Einzelunternehmer) nehmen wir angemessene Daten und Informationen über die Geschäftstätigkeiten des Kunden und das erwartete Muster und Ausmaß der Transaktionen auf.',
            textRequired9: 'Die Identität aller Kunden wird auf der Grundlage zuverlässiger Daten und Informationen überprüft, die aus unabhängigen und zuverlässigen Quellen stammen, d. h. Daten und Informationen, die schwer zu fälschen oder auf illegale Weise zu erlangen sind. ',
            performance: '// Durchführung durch Dritte',
            textPerformance: 'Wir können uns bei der Anwendung der Anforderungen in Bezug auf die Verfahren zur Kundenidentifizierung und die Sorgfaltspflicht gegenüber Kunden auf Dritte verlassen, sofern alle Daten und Informationen zur Kundenidentifizierung im Besitz der dritten Person sind und uns beglaubigte Kopien der Originale zur Verfügung gestellt werden.',
            on: '// Fortlaufende Überwachung und Aufzeichnung von Konten und Transaktionen',
            textOn1: 'Laufende Überwachung ist ein wesentlicher Aspekt wirksamer KYC-Verfahren. Wir können das Risiko nur dann wirksam kontrollieren und verringern, wenn wir die normalen und angemessenen Kontobewegungen unserer Kunden kennen, so dass wir über Mittel verfügen, um Transaktionen zu erkennen, die nicht in das reguläre Muster der Kontobewegungen fallen. Ohne ein solches Wissen ist es wahrscheinlich, dass die Bank ihrer Pflicht nicht nachkommt, verdächtige Transaktionen an die zuständigen Behörden zu melden, wenn sie dazu verpflichtet ist. Der Umfang der Überwachung muss risikoabhängig sein.',
            textOn2: 'Für alle Konten haben wir Systeme eingerichtet, um ungewöhnliche oder verdächtige Aktivitätsmuster zu erkennen. Dies geschieht durch die Festlegung von Limits für eine bestimmte Klasse oder Kategorie von Konten. Besonderes Augenmerk wird auf Transaktionen gelegt, die diese Grenzen überschreiten.',
            textOn3: 'Bestimmte Arten von Transaktionen weisen auf die Möglichkeit hin, dass der Kunde ungewöhnliche oder verdächtige Aktivitäten durchführt. Dazu können Transaktionen gehören, die wirtschaftlich oder kommerziell nicht sinnvoll erscheinen (Großtransaktionen) oder die hohe Bareinzahlungen beinhalten, die nicht mit den normalen und erwarteten Transaktionen des Kunden übereinstimmen.',
            textOn4: 'Konten mit höherem Risiko werden intensiver überwacht. Wir haben für solche Konten Schlüsselindikatoren festgelegt, die den Hintergrund des Kunden, wie das Herkunftsland und die Herkunft der Mittel, die Art der Transaktionen und andere Risikofaktoren berücksichtigen.',
            reporting: '// Verdächtige Aktivitäten melden',
            textReporting1: 'Im Einklang mit den einschlägigen Vorschriften werden alle verdächtigen Aktivitäten in Bezug auf Geldwäsche und Terrorismusfinanzierung nach einer Untersuchung den zuständigen Behörden gemeldet.\n',
            textReporting2: 'Beispiele für verdächtige Aktivitäten sind, sind jedoch nicht darauf beschränkt:\n' +
                '- Ungewöhnliche Kontobewegungen. Der Kunde möchte Transaktionen tätigen, die keinen Geschäftssinn oder keine offensichtliche Anlagestrategie erkennen lassen oder die nicht mit der vom Kunden angegebenen Geschäftsstrategie übereinstimmen.',
            textReporting3: '- Außerhalb des erwarteten Transaktionsvolumens oder der finanziellen Schwellenwerte.\n' +
                '- Die vom Kunden zur Verfügung gestellten Informationen, die eine legitime Quelle für Gelder angeben, sind falsch, irreführend oder im Wesentlichen falsch.\n' +
                '- Der Kunde weigert sich auf Anfrage, eine legitime Quelle für seine Gelder und andere Vermögenswerte anzugeben oder versäumt es, diese anzugeben.\n' +
                '- Der Kunde (oder eine Person, die öffentlich mit dem Kunden in Verbindung gebracht wird) hat einen fragwürdigen Hintergrund oder ist Gegenstand von Nachrichtenberichten, die auf mögliche straf-, zivil- oder aufsichtsrechtliche Verstöße hinweisen.\n' +
                '- Der Kunde zeigt sich wenig besorgt über Risiken, Provisionen oder andere Transaktionskosten.\n' +
                '- Der Kunde hat Schwierigkeiten, die Art seines Geschäfts zu beschreiben, oder es mangelt ihm an Allgemeinwissen über seine Branche.',
            record: '// Aufbewahrung von Aufzeichnungen',
            textRecord1: 'Die von unseren Kunden zur Verfügung gestellten Informationen werden für einen Zeitraum von fünf Jahren aufbewahrt und nach dem neuesten Stand der Technik geschützt. Die 5-Jahres-Frist wird nach der Durchführung der Transaktionen oder der Beendigung der Geschäftsbeziehung berechnet.',
            textRecord2: 'Insbesondere holen wir die Ausweispapiere unserer Kunden ein und bewahren Kopien davon mindestens fünf Jahre lang auf, nachdem ein Konto geschlossen wurde. Außerdem bewahren wir alle Aufzeichnungen über Finanztransaktionen mindestens fünf Jahre lang auf, nachdem unsere Geschäftsbeziehung mit dem Kunden beendet wurde oder eine Transaktion abgeschlossen wurde.',
            textRecord3: 'Die von uns erhaltenen Kundeninformationen werden in Übereinstimmung mit dem geltenden Recht vertraulich behandelt.',
            textRecord4: 'Die folgenden Aufzeichnungen werden aufbewahrt:\n' +
                '- Kopien des Beweismaterials für die Identität des Kunden;\n' +
                '- Relevantes Beweismaterial und Einzelheiten zu allen Geschäftsbeziehungen und Transaktionen, einschließlich der Dokumente für die Erfassung von Transaktionen in den Geschäftsbüchern;\n' +
                '- Einschlägige Dokumente des Schriftverkehrs mit den Kunden und anderen Personen, mit denen sie eine Geschäftsbeziehung unterhalten.',
            textRecord5: 'Alle Unterlagen und Informationen stehen den Behörden zur Erfüllung der ihnen gesetzlich auferlegten Pflichten schnell und unverzüglich zur Verfügung.',
            textRecord6: 'Die Dokumente und Informationen müssen im Original oder als beglaubigte Kopie vorliegen.',
            trading: '// Schulung der Mitarbeiter',
            textTrading1: 'Wir führen vor der Einstellung unserer Mitarbeiter eine umfassende Due-Diligence-Prüfung durch. Darüber hinaus werden unsere Mitarbeiter regelmäßig geschult, damit sie in den KYC-Verfahren angemessen geschult sind und mögliche Muster und Techniken der Geldwäsche erkennen und mögliche verdächtige Aktivitäten aufdecken können.',
            textTrading2: 'Der Zeitpunkt und der Inhalt der Schulungen für die verschiedenen Mitarbeiterkategorien wird von unserem Unternehmen an unsere eigenen Bedürfnisse angepasst. Die Schulungsanforderungen haben unterschiedliche Schwerpunkte für neue Mitarbeiter, Mitarbeiter an vorderster Front, Compliance-Mitarbeiter oder Mitarbeiter, die mit neuen Kunden zu tun haben.',
            textTrading3: 'Neue Mitarbeiter werden über die Bedeutung der KYC-Richtlinien und die grundlegenden Anforderungen geschult. Mitarbeiter, die direkt mit Kunden zu tun haben, werden darin geschult, die Identität neuer Kunden zu überprüfen, die Konten bestehender Kunden fortlaufend mit der gebotenen Sorgfalt zu behandeln und Muster verdächtiger Aktivitäten zu erkennen.',
            textTrading4: 'Durch regelmäßige Auffrischungsschulungen wird sichergestellt, dass die Mitarbeiter an ihre Pflichten erinnert und über neue Entwicklungen auf dem Laufenden gehalten werden.',
            regular: '// Regelmäßige Audits und Überprüfungen',
            textRegular1: 'Regelmäßige Audits werden von renommierten Wirtschaftsprüfungsgesellschaften durchgeführt, um sicherzustellen, dass die Richtlinien und Verfahren eingehalten werden. Unsere Richtlinien und Verfahren werden regelmäßig überprüft, um sicherzustellen, dass sie den aktuellen Vorschriften und dem externen Umfeld entsprechen.',
            textRegular2: 'Sollten Sie Fragen zum Inhalt dieser Richtlinie haben, zögern Sie bitte nicht, sich mit uns in Verbindung zu setzen, indem Sie die Angaben im Abschnitt Kontakte auf dieser Website verwenden.',
            additional: '// Zusätzliche Information',
            textAdditional1: 'Die Vorschriften verlangen, dass wir alle Kundeninformationen auf dem neuesten Stand halten, indem wir unsere Geschäftsbeziehungen kontinuierlich überwachen. Aus diesem Grund müssen wir unsere Kunden unter Umständen bitten, uns zusätzliche Dokumente und Informationen zukommen zu lassen.',
            textAdditional2: 'Wenn sich zu einem späteren Zeitpunkt die Eigentumsverhältnisse oder andere Details ändern, sollte der Kunde uns darüber informieren und alle neuen/aktualisierten Informationen und Dokumente vorlegen.',
            textAdditional3: 'Wenn im Land des potenziellen/bestehenden Kunden eines der erforderlichen Dokumente nicht in der von uns geforderten Form vorliegt, kann der Compliance-Beauftragte ein ähnliches Dokument akzeptieren, das den Erfordernissen der Sorgfaltspflicht entspricht.',
        },
        about: {
            descHead1: '%%COMPANY_NAME%% ist eine der größten Marken im CFD-Handel, und wir bei %%COMPANY_NAME%% arbeiten hart, um sicherzustellen, dass unsere Kunden die bestmöglichen Handels- und Investitionsentscheidungen treffen.',
            descHead2: 'Wenn Sie sich für %%COMPANY__NAME%% entscheiden, handeln Sie mit einem globalen Broker. Wir arbeiten Tag und Nacht daran, ein Handelsumfeld zu schaffen und zu erhalten, das jedem den Zugang zu den Märkten erleichtert - vom Anfänger bis zu denjenigen, die den Handel zu ihrem Beruf gemacht haben. Mit unserer Plattform können Sie handeln und investieren, wie Sie wollen, und dabei aus Hunderten der liquidesten Vermögenswerte wählen.',
            NdescHead3: 'Wir bieten ein zuverlässiges, vertrauenswürdiges und technologisch fortschrittliches Handelsumfeld und garantieren jedem Kunden einen tadellosen Service. Unsere Kunden haben für uns oberste Priorität. Deshalb stehen unsere Experten bereit, um alle Ihre Fragen per Telefon, E-Mail und Live-Chat zu beantworten.',
        },
        faq: {
            faq: 'FAQ (HÄUFIG GESTELLTE FRAGEN)',
            title1: 'Was bedeutet Leverage?',
            desc1: 'Die Leverage ist das Verhältnis zwischen der Höhe der Marge und dem geliehenen Betrag: 1:100, 1:200, 1:1000. Eine Hebelwirkung (Leverage) von 1:100 bedeutet, dass Sie über einen Betrag verfügen müssen, der 100 Mal kleiner ist als der Handelsbetrag, um einen Handel zu eröffnen. Bei CryptoWallSt können Sie eine Leverage von 1:1 bis 1:1000 wählen.',
            title2: 'Kann es sein, dass der Händler dem Unternehmen Geld schuldet?',
            desc2: 'Nein, das ist nicht möglich. Verliert ein Händler mehr, als er auf seinem Handelskonto hat, muss das Unternehmen den Verlust bis auf 0 ausgleichen.',
            title3: 'Wie hoch ist der Mindesteinzahlungsbetrag?',
            desc3: 'Der Mindesteinzahlungsbetrag beträgt $250 und ermöglicht es Ihnen, Trades für jedes Instrument zu eröffnen.',
            title4: 'Gibt es einen Unterschied zwischen Demo und echtem Handel?',
            desc4: 'Es gibt keine Unterschiede in den Handelsbedingungen und den Handelsinstrumenten. Der Handel auf einem Demo-Konto ist identisch mit dem realen Handel, außer dass es keine Möglichkeit gibt, auf einem Demo-Konto Einzahlungen und Auszahlungen zu tätigen',
            title5: 'Wie wird die Marge für eine Transaktion berechnet?',
            desc5: 'Die Höhe der Marge ist gleich dem Transaktionsvolumen geteilt durch die Leverage. Das Transaktionsvolumen ist gleich 10.000 $ multipliziert mit der Anzahl der Lots und dem Wechselkurs der Basiswährung des Paares zum US-Dollar. Die Basiswährung ist die erste Währung des Währungspaares. Zum Beispiel ist beim Währungspaar EUR/USD die Basiswährung EUR (folglich ist der Transaktionskurs zum US-Dollar EURUSD), beim Währungspaar USDCAD - USD (der Transaktionskurs zum US-Dollar ist gleich 1, da USD/USD = 1), beim Währungspaar GBPJPY - GBP ist die Basiswährung (der Transaktionskurs zum US-Dollar entspricht dem GBP/USD-Kurs oder dem GBPUSD-Kurs). Wenn also der GBPUSD bei 1,4956 steht, würde die Marge beim Handel mit 2 Lots und einer Leverage von 1:100 bei 10000 * 2 * GBPUSD/100 = 299,12 USD liegen. Wenn Sie 3,4 Lots auf USDJPY mit einer Leverage von 1:1000 handeln, wird die Marge 10000 * 3,5 * 1/1000 = 35 USD betragen.',
            title6: 'Wie viel werde ich verdienen, wenn ich mit einer Mindesteinlage in den Handel mit Kryptowährungen einsteige?',
            desc6: 'Das hängt ganz von Ihren Erfahrungen, Kenntnissen und Fähigkeiten ab. Der Handel mit Kryptowährungen ist sehr risikoreich, und Sie müssen dieses Risiko akzeptieren und Ihr Niveau an Professionalität einschätzen. Die Handelsbedingungen von CryptoWallSt machen Ihre Reise vom Anfänger zum erfahrenen Händler einfach.',
            title7: 'Wie sind die Handelszeiten für Kryptowährungen?',
            desc7: 'Kryptowährungen werden rund um die Uhr gehandelt (24/7).',
            title8: 'Ich habe mein Passwort vergessen (oder möchte das Passwort meines Händlers ändern). Was sollte ich tun?',
            desc8: 'Sie können Ihr Passwort ändern, indem Sie sich mit den folgenden Informationen an den Kundendienst wenden: E-Mail-Adresse, Kontonummer. Sobald Ihre Identität bestätigt wurde, erhalten Sie einen eindeutigen Link, mit dem Sie Ihr Passwort ändern können. (lateinische Buchstaben, 6 bis 12 Zeichen). Das Passwort Ihres Kontos wird nach Ihrem Ermessen wiederhergestellt oder geändert.',
            title9: 'Does the company charge any fees for depositing money to your Account?',
            desc9: '%%COMPANY_NAME%% erhebt keine Gebühren für die Einzahlung von Geld auf Ihr Handelskonto. Das Zahlungssystem oder die Bank, die Ihr Konto gutschreibt oder belastet, erhebt jedoch eine Gebühr auf den Betrag Ihrer Transaktion.',
            title10: 'Wie hoch ist der Mindestentnahmebetrag?',
            desc10: 'Es gibt keine Einschränkungen für Abhebungen. Sie können jederzeit eine Auszahlung des Restbetrags auf Ihrem Handelskonto beantragen. Die einzige Ausnahme sind Banküberweisungen (Mindestabhebung: 300 $). Bei elektronischen Brieftasche, elektronischen Zahlungssystemen und Bankkarten beträgt der Mindestbetrag für eine Abhebung 1 USD einschließlich Provision. Beachten Sie auch die Gebühr, die die Bank für die Transaktion erheben kann: bis zu 30 USD.',
            title11: 'Was bedeutet Kontoverifizierung? Darf ich mit einem nicht verifizierten Konto handeln?',
            desc11: 'Verifizierung bedeutet Kundenidentifizierung. Es schützt Ihr Handelskonto, wenn Sie Ihr Passwort oder andere sensible Daten wiederherstellen. Das Verfahren zur Überprüfung des Kontos hat keinen Einfluss auf die Bearbeitung Ihres Geldes. Sie können Ihr Konto jederzeit verifizieren.',
            title12: 'Wie lange dauert es, das Konto zu verifizieren?',
            desc12: 'Die Verifizierung des Kontos kann bis zu 72 Arbeitsstunden dauern.',
            title13: 'Welche Dokumente werden zur Verifizierung des Kontos benötigt?',
            desc13: 'Es wird jede Form des Ausweises akzeptiert. Bevorzugt werden ein Reisepass (ID) oder ein Führerschein sowie die Nebenkostenabrechnungen der letzten zwei Monate.',
            title14: 'Ich habe eine E-Mail erhalten, in der mir mitgeteilt wird, dass mein Dokument nicht zur Verifizierung angenommen wurde. Was soll ich tun?',
            desc14: 'Das Dokument wird in folgenden Fällen nicht zur Verifizierung akzeptiert: Die eingescannte Kopie des Dokuments ist von schlechter Qualität. Sie haben ein für die Verifizierung ungeeignetes Dokument geschickt (kein Foto oder Name). Das von Ihnen eingesandte Dokument wurde bereits für die erste Überprüfungsstufe verwendet oder der Ausweis hat kein Ablaufdatum.',
        },
        contacts: {
            title:'Unsere Kontakte',
            desc: 'Kundenzufriedenheit ist unsere oberste Priorität! Unser Support-Team steht Ihnen rund um die Uhr zur Verfügung, um Ihnen bei allen Fragen zu unserer Plattform zu helfen: Ein- und Auszahlungen, Handelsoperationen, Konten und Einstellungen, etc.\n' +
                'Sie können uns auf jede beliebige Weise kontaktieren:',
            label1: 'Name',
            label2: 'E-mail',
            label3: 'Eine Beschreibung eingeben',
            agree: 'Ich bin mit der verarbeitung der angegebenen personenbezogenen Daten einverstanden',
        },
        modal: {
            title1: 'Prüfen Sie, ob die eingegebenen Daten korrekt sind!',
            title2: 'There was an error form was not sent, check your Internet connection!',
            title3: 'The form is being sent, please wait',
            title4: 'Form sent successfully!',
        },
        footer: {
            copy: 'Differenzkontrakte (Contracts for Difference, CFDs) sind komplexe Finanzprodukte, die auf Marge gehandelt werden. Der Handel mit CFDs birgt ein hohes Maß an Risiko. Sie könnten Ihr gesamtes Kapital verlieren. Diese Produkte sind möglicherweise nicht für jeden geeignet, und Sie müssen sicherstellen, dass Sie die damit verbundenen Risiken verstehen. Lassen Sie sich bei Bedarf unabhängig beraten und spekulieren Sie nur mit Geldern, die Sie sich leisten können, zu verlieren. Der Inhalt dieser Seite dient ausschließlich Informationszwecken und stellt keine Beratung oder Empfehlung dar. Der Kunde trägt die alleinige Verantwortung für alle getätigten Transaktionen oder Investitionen. Wir bieten unsere Dienste den Einwohnern bestimmter Länder, wie Afghanistan, Hongkong, Japan, den Vereinigten Staaten von Amerika und bestimmten anderen Regionen, nicht an.',
            copyText: 'Copyright',
        },
        key: {
            text: "SCHLÜSSELFESTSTELLUNGEN"
        },
        table: {
            name: 'Name',
            symbol: 'Symbol',
    ...
    it: {
        ...
        hero: {
            title3: 'Sistema di trading CFD professionale',
            desc: 'La strada per la tua libertà finanziaria. Iscriviti oggi stesso e guadagna con i nostri servizi e le nostre soluzioni.',
            btnText: 'Registrati',
        },
        markets: {
            title: 'MERCATI',
            ...
            itemTitle1: 'Azioni',
            itemDesc1: 'Oltre 200 società pubbliche conosciute',
            itemTitle2: 'Criptovalute',
            itemDesc2: 'Bitcoin, altcoin affermate ed emergenti',
            itemTitle3: 'Materie prime',
            itemDesc3: 'Petrolio e gas, industriali e agricole',
            itemTitle4: 'Indici',
            itemDesc4: 'Principali indicatori dell\'economia mondiale',
            itemTitle5: 'Forex',
            itemDesc5: 'Coppie di valute principali ed esotiche',
            itemTitle6: 'Metalli',
            itemDesc6: 'Oro, argento, altri metalli preziosi e industriali',
            itemTitle7: 'NFTs',
            itemDesc7: 'Indici che seguono le collezioni di NFT più popolari',
        },
        features: {
            mainCardTitle: 'Facile accesso alle opportunità di investimento',
            mainDesc: 'Non è mai troppo tardi per iniziare il vostro viaggio nel mondo della finanza e garantire un futuro ricco e sostenibile per voi e la vostra famiglia. La nostra visione è che la libertà finanziaria sia fondamentale e che l\'accesso alle opportunità di investimento debba essere illimitato. Per questo motivo offriamo il modo più semplice, veloce e conveniente di iniziare a fare trading per un normale investitore al dettaglio.',
            title1: 'Trading sicuro e protetto',
            desc1: 'Con il nostro software professionale di alto livello',
            title2: 'Nessuna commissione',
            desc2: 'Negoziare quanto si vuole',
            title3: 'Conti multipli in diverse valute',
            desc3: 'Gestite i vostri fondi a modo vostro',
            title4: 'I mercati mondiali più liquidi',
            desc4: 'Azioni, criptovalute, materie prime, forex, indici ed ETF',
            title5: 'Negoziare ovunque',
            desc5: 'Da qualsiasi luogo con accesso a Internet',
            title6: 'Prelievi rapidi garantiti',
            desc6: 'Prendete i vostri profitti ogni volta che ne avete bisogno',
        },
        cryptoNft: {
            title: 'Investire in criptovalute e NFT',
            desc: 'Le criptovalute sono oggi di gran moda. È il mercato in più rapida crescita e con i migliori rendimenti del 21° secolo. Le criptovalute sono il luogo in cui una sofisticata tecnologia all\'avanguardia incontra grandi opportunità di profitto senza limiti di accesso. Bitcoin e altcoin sono essenziali per qualsiasi sistema di trading di criptovalute, ma abbiamo qualcosa di speciale per voi! L\'opportunità di negoziare gli indici NFT è una caratteristica speciale, nuova e interessante della nostra piattaforma!',
        },
        slider: {
            title: 'Forniamo gli indici per le collezioni NFT più popolari negoziate al momento'
        },
        privacy: {
            title: "INFORMATIVA SULLA PRIVACY ",
            descHead1: 'La presente Informativa sulla privacy disciplina il modo in cui %%COMPANY_NAME%% raccoglie, utilizza, conserva e divulga le informazioni raccolte dagli utenti ("Utenti", "Utente") del sito web %%COMPANY_LINK%% ("Sito"). La presente informativa sulla privacy si applica al Sito e a tutti i prodotti e servizi offerti dalla società.',
            personal: 'Informazioni di identificazione personale',
            textPersonal: 'Possiamo raccogliere informazioni di identificazione personale dagli Utenti in vari modi, tra cui, ma non solo, quando gli Utenti visitano il Sito, si registrano sul Sito o si iscrivono alla newsletter e in relazione ad altre attività, servizi, funzioni o risorse che rendiamo disponibili sul Sito. Agli Utenti possono essere richiesti, a seconda dei casi, nome, indirizzo e-mail, indirizzo postale, numero di telefono e informazioni sulla carta di credito.',
            user: 'Gli utenti possono tuttavia visitare il Sito in forma anonima',
            textUser: 'PRaccoglieremo informazioni di identificazione personale dagli utenti solo se questi ci forniranno volontariamente tali informazioni. Gli utenti possono sempre rifiutarsi di fornire informazioni di identificazione personale, tranne che per il fatto che ciò potrebbe impedire loro di partecipare a determinate attività correlate al Sito.',
            nonPeronal: 'Informazioni di identificazione non personali',
            textNonPeronal: 'Possiamo raccogliere informazioni di identificazione non personali sugli utenti ogni volta che interagiscono con il nostro Sito. Le informazioni di identificazione non personale possono includere il nome del browser, il tipo di computer e le informazioni tecniche sui mezzi di connessione dell\'Utente al nostro Sito, come il sistema operativo e i fornitori di servizi Internet utilizzati e altre informazioni simili.',
            web: 'Cookie del browser web',
            textWeb: 'Il nostro sito può utilizzare i "cookie" per migliorare l\'esperienza dell\'utente. Il browser web dell\'utente inserisce i cookie sul suo disco rigido per scopi di registrazione e talvolta per tracciare informazioni sull\'utente stesso. L\'utente può scegliere di impostare il proprio browser web in modo da rifiutare i cookie o da essere avvisato dell\'invio di cookie. In tal caso, alcune parti del Sito potrebbero non funzionare correttamente.',
            use: 'Come utilizziamo le informazioni raccolte',
            textUse: 'Raccogliamo e utilizziamo le informazioni personali degli utenti per i seguenti scopi: \n' +
                '- Migliorare il servizio clienti. Le informazioni dell\'Utente ci aiutano a rispondere in modo più efficace alle richieste di assistenza e supporto dei clienti. \n' +
                '- Per personalizzare l\'esperienza dell\'utente. Possiamo utilizzare le informazioni in forma aggregata per capire come i nostri utenti, come gruppo, utilizzano i servizi e le risorse fornite sul nostro Sito. \n' +
                '- Per migliorare il nostro Sito. Ci impegniamo costantemente a migliorare le offerte del nostro sito web sulla base delle informazioni e dei feedback che riceviamo dagli utenti. \n' +
                '- Per elaborare le transazioni. Possiamo utilizzare le informazioni fornite dagli utenti quando effettuano un ordine solo per fornire il servizio relativo a tale ordine. Non condividiamo queste informazioni con terzi se non nella misura necessaria a fornire il servizio. \n' +
                '- Per gestire un concorso, una promozione, un sondaggio o altre funzioni del sito. \n' +
                '- Per inviare agli utenti informazioni che hanno accettato di ricevere su argomenti che riteniamo possano essere di loro interesse. \n' +
                '- Per inviare e-mail periodiche. L\'indirizzo e-mail fornito dagli utenti per l\'elaborazione dell\'ordine sarà utilizzato solo per inviare loro informazioni e aggiornamenti relativi all\'ordine. Potrà inoltre essere utilizzato per rispondere alle loro richieste e/o ad altre richieste o domande. Se l\'Utente decide di aderire alla nostra mailing list, riceverà messaggi di posta elettronica contenenti notizie, aggiornamenti, informazioni su prodotti o servizi correlati, ecc. Se in qualsiasi momento l\'Utente desidera annullare la ricezione di future e-mail, includiamo istruzioni dettagliate per l\'annullamento dell\'iscrizione in fondo a ogni e-mail o l\'Utente può contattarci tramite il nostro Sito. \n',
            protect: 'Come proteggiamo le vostre informazioni',
            textProtect: 'Adottiamo pratiche appropriate di raccolta, archiviazione ed elaborazione dei dati e misure di sicurezza per proteggere gli Utenti dall\'accesso non autorizzato, dall\'alterazione, dalla divulgazione o dalla distruzione delle loro informazioni personali, del nome utente, della password, delle informazioni sulle transazioni e dei dati archiviati sul nostro Sito. Lo scambio di dati sensibili e privati tra il Sito e i suoi utenti avviene su un canale di comunicazione protetto da SSL ed è criptato e protetto da firme digitali.',
            compliance: 'Conformità alla protezione della privacy online dei bambini',
            textCompliance: 'La protezione della privacy dei più giovani è particolarmente importante. Per questo motivo, non raccogliamo o conserviamo mai informazioni sul nostro sito da chi sappiamo essere minore di 18 anni, e nessuna parte del nostro sito è strutturata in modo da attirare i minori di 18 anni.',
            changes: 'Modifiche alla presente informativa sulla privacy',
            textChanges: 'Abbiamo la facoltà di aggiornare questa politica sulla privacy in qualsiasi momento. In tal caso, la data di aggiornamento sarà riportata in fondo a questa pagina. Incoraggiamo gli utenti a controllare frequentemente questa pagina per eventuali modifiche, in modo da rimanere informati su come stiamo contribuendo a proteggere le informazioni personali che raccogliamo. L\'utente riconosce e accetta che è sua responsabilità rivedere periodicamente la presente Informativa sulla privacy e venire a conoscenza di eventuali modifiche.',
            acceptance: 'L\'accettazione di questi termini da parte dell\'utente',
            textAcceptance: 'Utilizzando il Sito, l\'utente accetta la presente informativa e i termini di servizio. Se non si accettano le presenti norme, si prega di non utilizzare il Sito. L\'uso continuato del Sito dopo la pubblicazione di modifiche a questa politica sarà considerato come l\'accettazione di tali modifiche.',
            contacting: 'Contattateci',
            textContacting: 'In caso di domande sulla presente Informativa sulla privacy, sulle pratiche del Sito o sui rapporti con il Sito stesso, si prega di contattarci a proprio piacimento utilizzando i dati riportati nella sezione Contatti del Sito.',
        },
        disclaimer: {
            title: 'DISCLAIMER',
            descHead: 'La negoziazione di attività come le criptovalute con o senza margine è ad alto rischio, può comportare un rischio sostanziale di una parte o della totalità del vostro investimento e potrebbe non essere adatta a tutti gli investitori.',
            disclosure: 'Divulgazione del rischio',
            textDisclosure: 'La negoziazione e l\'esecuzione di operazioni simili a quelle descritte e/o risultanti dalla presente clausola di esclusione della responsabilità, con o senza l\'uso di leva finanziaria o margine, è una negoziazione speculativa ad alto rischio. Dovete valutare attentamente e seriamente se questo tipo di attività finanziaria si adatta alle vostre esigenze, alle vostre risorse finanziarie e alla vostra situazione personale. Poiché il rischio di perdere una parte o la totalità dei fondi investiti in un periodo di tempo relativamente breve è elevato, si raccomanda di utilizzare solo i fondi destinati a operazioni finanziarie speculative e ad alto rischio. In particolare, occorre prestare attenzione ai seguenti punti:',
            currency: 'Rischio valutario',
            textCurrency: 'Le fluttuazioni dei tassi nei mercati delle criptovalute e delle valute sono spesso brusche senza che sia possibile prevedere l\'entità o la direzione della variazione o l\'arco di tempo in cui si verifica.',
            event: 'Rischio di evento',
            textEvent: 'I prezzi possono fluttuare rapidamente a seguito di circostanze impreviste, eventi o cambiamenti di condizioni.',
            operational: 'Rischio operativo',
            textOperational: 'Anche se faremo ogni sforzo ragionevole per garantire la continuità dei servizi, il rischio operativo, come le interruzioni delle comunicazioni, dei computer, delle reti o gli eventi esterni, può portare a ritardi nell\'esecuzione e nel regolamento di una transazione. L\'utilizzo di un software di trading elettronico comporta l\'esposizione a rischi legati al software, a internet, ai sistemi di comunicazione e alle interfacce a noi collegate. I rischi includono, a titolo esemplificativo ma non esaustivo, crash di hardware, software, linee e sistemi e/o alimentazione di dati errati da parte di fornitori di dati esterni. Nessun sistema di trading è esente da guasti occasionali e non esiste un sistema che possa garantire un profitto del 100% o che non sia esposto a perdite.',
            margin: ' Rischio di margine',
            textMargin1: 'La leva o il margine nel trading di criptovalute viene creato sulla base di garanzie collaterali di importo ridotto rispetto alla transazione totale. Il risultato del trading con leva o con margine è che una piccola variazione dei prezzi di mercato, in un breve periodo di tempo, può causare un guadagno o una perdita sostanziale, proporzionale alla dimensione della garanzia, fino alla perdita totale della somma della garanzia in un periodo di tempo molto breve.',
            textMargin2: 'Questa avvertenza non copre tutti i possibili rischi connessi al tipo di operazioni descritte e/o risultanti da questo Disclaimer.',
        },
        kyc: {
            title: 'CONOZCA A SU CLIENTE',
            descHead1: '%%COMPANY_NAME%% se compromete a cumplir con todas las regulaciones pertinentes en materia de ALD y financiación del terrorismo y la siguiente política se ha derivado de los principios generales, leyes, reglamentos y directivas para la lucha contra el lavado de dinero.',
            descHead2: 'Creemos que el cumplimiento de la normativa AML y CFT es esencial para la integridad de los sistemas financieros y la prevención de que nuestra empresa sea utilizada, intencionadamente o no, por elementos criminales.',
            descHead3: 'Hemos puesto en marcha programas de conocimiento del cliente (KYC) como elemento esencial para los procedimientos de servicio, gestión de riesgos y control. Estamos obligados no sólo a establecer la identidad de sus clientes, sino también a supervisar la actividad de la cuenta para determinar aquellas transacciones que no se ajustan a las operaciones normales o esperadas para ese cliente o tipo de cuenta. El programa también incluye requisitos de mantenimiento de registros, la notificación de actividades sospechosas y la formación en materia de lucha contra el blanqueo de capitales.',
            money: 'Qué es el blanqueo de capitales?',
            textMoney1: 'El blanqueo de capitales incluye todas las formas de manipulación o posesión de bienes delictivos, incluida la posesión del producto del propio delito, y la facilitación de cualquier manipulación o transferencia de bienes delictivos para otra persona; incluido el producto derivado de cualquier acto de fraude, soborno o corrupción. Cuando los bienes delictivos incluyen dinero o valor monetario, valores, bienes tangibles e intangibles; incluyendo la recepción, manejo y transferencia de fondos derivados de la delincuencia.',
            textMoney2: 'Una visión simplificada de una operación eficaz de blanqueo de capitales implica tres etapas:',
            textMoney3: '1. Colocación del dinero físico (por ejemplo, en una cuenta bancaria). Una visión simplificada de una operación eficaz de blanqueo de capitales implica tres etapas',
            textMoney4: '2. Estratificación. Utilizando fondos de la cuenta bancaria y realizando múltiples transacciones que confunden la pista de auditoría y separan el dinero de su origen ',
            textMoney5: '3. Integración de los ingresos blanqueados en la economía legítima, de modo que parezca que son legítimos al presentarse como fondos comerciales normales.',
            textMoney6: 'A los efectos de esta política, el blanqueo de capitales también incluye las actividades relacionadas con la financiación del terrorismo, incluido el manejo o la posesión de fondos para ser utilizados con fines terroristas, así como los productos del terrorismo.',
            textMoney7: 'Cuando tratamos con clientes, estamos atentos a la posibilidad de que los clientes, sus contrapartes u otras personas (con o sin la participación consciente del cliente) intenten blanquear dinero utilizando nuestros servicios, mediante la superposición o la integración.',
            kyc: 'Conozca a su cliente',
            textKyc1: 'Hacemos una serie de preguntas a los clientes durante la fase de solicitud para conocerlos y asegurarnos de que el solicitante no es víctima de un delito financiero. Se recoge la documentación de los clientes para verificar la información proporcionada en la fase de solicitud. Estos documentos pueden ser verificados electrónicamente durante el proceso de solicitud.',
            textKyc2: 'Periódicamente, también solicitamos a los clientes que actualicen la información personal que han proporcionado en la fase de solicitud para garantizar que los datos y la información sobre sus clientes estén actualizados.',
            customer: 'Accettazione dei clienti',
            textCustomer1: 'Manteniamo chiare politiche e procedure di accettazione dei clienti, compresa una descrizione delle tipologie di clienti che possono rappresentare un rischio superiore alla media. Prima di accettare un potenziale cliente, vengono seguite le procedure KYC e di due diligence, esaminando fattori quali il background del cliente, il paese di origine, la posizione pubblica o di alto profilo, i conti collegati, le attività commerciali o altri indicatori di rischio.',
            textCustomer2: 'Una due diligence approfondita è essenziale per un individuo con un patrimonio netto elevato ma la cui fonte di fondi non è chiara. Il denaro dei nuovi clienti viene trasferito attraverso una banca affidabile. Le banche hanno le loro procedure antiriciclaggio. La decisione di intrattenere rapporti d\'affari con clienti ad alto rischio, come le persone politicamente esposte, viene presa esclusivamente a livello di senior management.',
            control: 'Controlli',
            textControl: 'Abbiamo una serie di controlli interni che includono, a titolo esemplificativo, la non accettazione di contanti e la non accettazione di depositi e rimborsi di terzi. Non accetteremo come clienti persone o entità provenienti da paesi o organizzazioni soggetti a restrizioni o sanzioni. I punti di riferimento per tali verifiche includono i siti web di: \n' +
                '- Dipartimento australiano degli Affari Esteri e del Commercio, \n' +
                '- Elenchi consolidati delle nazioni, \n' +
                '- Ufficio statunitense per il controllo dei beni esteri, \n' +
                '- GAFI. \n' +
                'Non accettiamo cittadini statunitensi. \n' +
                'Non accettiamo conti anonimi e non intratteniamo rapporti con banche di comodo.\n',
            identification: 'Identificazione del cliente',
            textIdentification1: 'dipendono dal tipo di richiedente (personale, aziendale, ecc.) e dalle dimensioni previste del conto.',
            textIdentification2: 'L\'identificazione del cliente è un elemento essenziale degli standard KYC. Ai fini della presente politica, un cliente comprende: \n' +
                '- La persona o l\'entità che detiene un conto o coloro per conto dei quali viene mantenuto un conto (ossia i titolari effettivi); \n' +
                '- I beneficiari di transazioni condotte da intermediari professionali; \n' +
                '- qualsiasi persona o entità collegata a una transazione finanziaria che possa rappresentare un rischio significativo di reputazione o di altro tipo per la nostra azienda. \n',
            textIdentification3: 'L\'identificazione del cliente deve essere effettuata non appena ragionevolmente possibile dopo il primo contatto. Manteniamo una procedura sistematica per l\'identificazione dei nuovi clienti e non possiamo avviare un rapporto di servizio finché l\'identità di un nuovo cliente non è stata verificata in modo soddisfacente.',
            textIdentification4: 'Prestiamo particolare attenzione nel caso di clienti non residenti e in nessun caso vengono seguite procedure di identità in cortocircuito solo perché il nuovo cliente non è in grado di presentare documenti e informazioni sufficienti a soddisfare le procedure KYC e di due diligence.',
            textIdentification5: 'Nell\'ambito dell\'obbligo di esercitare la dovuta diligenza nell\'identificazione dei clienti, dobbiamo confermare che le informazioni sull\'identità in possesso dei nostri clienti rimangono completamente aggiornate con tutte le informazioni e le identificazioni necessarie per tutta la durata del rapporto commerciale. Esaminiamo e controlliamo regolarmente la validità e l\'adeguatezza delle informazioni di identificazione dei clienti in suo possesso.',
            textIdentification6: 'Se il cliente si rifiuta o non ci fornisce i documenti e le informazioni richieste per l\'identificazione, prima di avviare il rapporto d\'affari o durante l\'esecuzione di una singola transazione senza un\'adeguata giustificazione, non procederemo al rapporto contrattuale o non eseguiremo la transazione e potremo anche segnalarlo al Supervisore AML/CFT. Ciò può far sorgere il sospetto che il cliente sia coinvolto in attività di riciclaggio di denaro e finanziamento del terrorismo.',
            required: 'Informazioni richieste al cliente e informazioni di verifica',
            textRequired1: 'Per i nuovi clienti verranno raccolte le seguenti informazioni: \n' +
                '- Nome completo vero e/o nomi utilizzati; \n' +
                '- Indirizzo permanente attuale, compreso il codice postale; \n' +
                '- Data di nascita; \n' +
                '- professione o occupazione.\n',
            textRequired2: 'I nomi devono essere verificati mediante referenze ottenute da una fonte attendibile che rechi una fotografia, come ad esempio: \n' +
                '- Passaporto completo in corso di validità; \n' +
                '- Carta d\'identità con foto rilasciata dal governo. \n',
            textRequired3: 'Non cercheremo di determinare se il documento fornito dal cliente per l\'identificazione sia stato validamente emesso. Ai fini della verifica, ci baseremo su un documento di identità rilasciato dal governo per stabilire l\'identità di un cliente. Tuttavia, analizzeremo le informazioni fornite per determinare se vi siano incongruenze logiche nelle informazioni ottenute.',
            textRequired4: 'Oltre alla verifica del nome del cliente, l\'indirizzo permanente attuale verrà verificato ottenendo uno dei seguenti documenti in originale: \n' +
                '- Copia di una bolletta recente; \n' +
                '- Bolletta del fisco locale; \n' +
                '- Estratto conto bancario; \n' +
                '- estratto conto mensile della carta di credito. \n',
            textRequired5: 'Per i clienti aziendali verranno raccolte le seguenti informazioni: \n' +
                '- L\'originale o la copia certificata del certificato di costituzione; \n' +
                '- Statuto, Memorandum e articoli di associazione; \n' +
                '- Delibera del Consiglio di Amministrazione per effettuare transazioni sul mercato delle criptovalute e conferire l\'autorità a coloro che agiranno per il cliente; \n' +
                '- Registri degli amministratori e degli azionisti; \n' +
                '- identità dei soggetti collegati alla Società; \n' +
                '- il profilo aziendale della Società in termini di natura e portata delle attività; \n',
            textRequired6: 'Ricerche societarie e altre indagini commerciali per verificare che il richiedente non sia stato o non sia in procinto di essere sciolto, radiato, liquidato o chiuso. Se si verificano cambiamenti nella struttura aziendale o nella proprietà dopo l\'apertura di un conto con la Società, verranno effettuati ulteriori controlli.',
            textRequired7: 'La verifica dell\'identità per i clienti aziendali mira a identificare: \n' +
                '- La Società; \n' +
                '- gli Amministratori; \n' +
                '- Tutte le persone debitamente autorizzate a operare sul conto; \n' +
                '- Struttura proprietaria; \n' +
                '- In caso di società private, i principali azionisti beneficiari; \n' +
                '- L\'ultimo bilancio certificato (se disponibile). \n',
            textRequired8: 'Dobbiamo verificare l\'identità dei beneficiari effettivi dei conti. Per le persone giuridiche, abbiamo bisogno di tali dati e informazioni per comprendere la struttura proprietaria e di controllo del cliente. Indipendentemente dalla tipologia del cliente (ad esempio persona fisica o giuridica, società di persone o ditta individuale), raccogliamo dati e informazioni adeguati sulle attività commerciali del cliente e sul modello e livello di transazioni previsto.',
            textRequired9: 'L\'identità di tutti i clienti viene verificata sulla base di dati e informazioni affidabili forniti o ricevuti da fonti indipendenti e attendibili, ossia quei dati e quelle informazioni che è difficile falsificare o ottenere in modo illegale.',
            performance: 'Esecuzione da parte di terzi',
            textPerformance: 'Possiamo affidarci a terzi per l\'applicazione dei requisiti relativi alle procedure di identificazione del cliente e alle misure di due diligence del cliente, a condizione che tutti i dati e le informazioni siano in possesso della terza persona per l\'identificazione del cliente e che ci vengano fornite copie certificate degli originali.',
            on: 'Monitoraggio continuo e registrazione di conti e transazioni',
            textOn1: 'Il monitoraggio continuo è un aspetto essenziale di procedure KYC efficaci. Possiamo controllare e ridurre efficacemente il rischio solo se abbiamo una comprensione dell\'attività normale e ragionevole dei nostri clienti, in modo da avere i mezzi per identificare le transazioni che non rientrano nello schema regolare dell\'attività di un conto. Senza tale conoscenza, è probabile che l\'azienda non riesca a rispettare l\'obbligo di segnalare le transazioni sospette alle autorità competenti nei casi in cui ciò sia richiesto. L\'entità del monitoraggio deve essere sensibile al rischio.',
            textOn2: 'Per tutti i conti, disponiamo di sistemi per individuare modelli di attività insoliti o sospetti. A tal fine vengono stabiliti dei limiti per una particolare classe o categoria di conti. Particolare attenzione viene prestata alle transazioni che superano tali limiti.',
            textOn3: 'Alcuni tipi di transazioni segnalano la possibilità che il cliente stia conducendo attività insolite o sospette. Si tratta di transazioni che non sembrano avere senso dal punto di vista economico o commerciale (grandi transazioni), o che comportano depositi di contanti di importo elevato che non sono coerenti con le normali e previste transazioni del cliente.',
            textOn4: 'Il monitoraggio dei conti a rischio più elevato è intensificato. Abbiamo stabilito degli indicatori chiave per tali conti, tenendo conto del background del cliente, come il paese di origine e la fonte dei fondi, il tipo di transazioni coinvolte e altri fattori di rischio.',
            reporting: 'Segnalazione di attività sospette',
            textReporting1: 'In linea con le normative vigenti, qualsiasi attività sospetta di riciclaggio di denaro e finanziamento del terrorismo viene segnalata alle autorità competenti, previa indagine.',
            textReporting2: 'Esempi di attività sospette sono, a titolo esemplificativo ma non esaustivo:',
            textReporting3: '- Attività di conto fuori dall\'ordinario. Il cliente desidera effettuare transazioni prive di senso commerciale o di un\'apparente strategia di investimento, o non coerenti con la strategia commerciale dichiarata dal cliente. \n' +
                '- volumi di transazioni o soglie finanziarie al di fuori della gamma prevista. \n' +
                '- Le informazioni fornite dal cliente per identificare una fonte legittima di fondi sono false, fuorvianti o sostanzialmente errate. \n' +
                '- Su richiesta, il cliente rifiuta di identificare o non indica alcuna fonte legittima per i suoi fondi e altri beni. \n' +
                '- Il cliente (o una persona pubblicamente associata al cliente) ha un passato discutibile o è oggetto di notizie che indicano possibili violazioni penali, civili o normative. \n' +
                '- Il cliente non si preoccupa dei rischi, delle commissioni o di altri costi di transazione. \n' +
                '- Il cliente ha difficoltà a descrivere la natura della sua attività o non ha una conoscenza generale del suo settore.\n',
            record: 'Conservazione dei dati',
            textRecord1: 'Le informazioni fornite dai nostri clienti vengono conservate per un periodo di cinque anni e protette utilizzando le tecnologie più avanzate. Il periodo di 5 anni viene calcolato dopo l\'esecuzione delle transazioni o la fine del rapporto commerciale.',
            textRecord2: 'In particolare, otteniamo i documenti di identificazione dei clienti e ne conserviamo le copie per almeno cinque anni dopo la chiusura del conto. Conserviamo inoltre tutti i registri delle transazioni finanziarie per almeno cinque anni dalla data in cui il nostro rapporto con il cliente è terminato o una transazione è stata completata.',
            textRecord3: 'Le informazioni ricevute dai clienti vengono trattate con riservatezza in conformità alle leggi vigenti.',
            textRecord4: 'Vengono conservati i seguenti documenti: \n' +
                '- Copie del materiale probatorio dell\'identità del cliente; \n' +
                '- materiale probatorio pertinente e dettagli di tutte le relazioni e transazioni commerciali, compresi i documenti per la registrazione delle transazioni nei libri contabili; \n' +
                '- documenti rilevanti della corrispondenza con i clienti e con altre persone con cui si intrattengono rapporti commerciali.\n',
            textRecord5: 'Tutti i documenti e le informazioni sono disponibili rapidamente e senza ritardi per le autorità al fine di adempiere ai doveri imposti dalla legge.',
            textRecord6: 'I documenti e le informazioni devono essere originali o copie certificate conformi.',
            trading: 'Formazione dei dipendenti',
            textTrading1: 'Prima dell\'assunzione conduciamo un\'approfondita due diligence sui nostri dipendenti. Inoltre, i nostri dipendenti ricevono una formazione periodica in modo da essere adeguatamente addestrati alle procedure KYC e da essere consapevoli di possibili modelli e tecniche di riciclaggio di denaro e di individuare eventuali attività sospette.',
            textTrading2: 'I tempi e i contenuti della formazione per le varie categorie di dipendenti sono adattati dall\'azienda alle proprie esigenze. I requisiti di formazione sono diversi per i nuovi dipendenti, per quelli in prima linea, per quelli che si occupano di compliance o per quelli che hanno a che fare con nuovi clienti.',
            textTrading3: 'I nuovi dipendenti vengono istruiti sull\'importanza delle politiche KYC e sui requisiti di base. I dipendenti che trattano direttamente con i clienti vengono addestrati a verificare l\'identità dei nuovi clienti, a esercitare la dovuta diligenza nella gestione dei conti dei clienti esistenti su base continuativa e a rilevare modelli di attività sospette.',
            textTrading4: 'Vengono organizzati periodicamente corsi di aggiornamento per garantire che i dipendenti si ricordino delle loro responsabilità e siano tenuti al corrente dei nuovi sviluppi.',
            regular: 'Audit e revisioni regolari',
            textRegular1: 'Vengono effettuate verifiche periodiche da parte di società di revisione affidabili per garantire il rispetto delle politiche e delle procedure. Le nostre politiche e procedure vengono riviste regolarmente per verificare che rispecchino le normative vigenti e l\'ambiente esterno.',
            textRegular2: 'In caso di domande o dubbi sui contenuti di questa politica, non esitate a contattarci utilizzando i dati riportati nella sezione Contatti di questo sito.',
            additional: 'Nota informativa aggiuntiva',
            textAdditional1: 'Le normative ci impongono di mantenere aggiornate tutte le informazioni sui clienti, monitorando costantemente i nostri rapporti commerciali. Per questo motivo potremmo dover chiedere ai nostri clienti di fornirci ulteriori documenti e informazioni, se necessario.',
            textAdditional2: 'Se in una fase successiva si verificano cambiamenti nella struttura dello stato di proprietà o in qualsiasi altro dettaglio, il cliente deve informarci e fornire tutte le informazioni e i documenti nuovi/aggiornati.',
            textAdditional3: 'Se nel paese del cliente potenziale/esistente uno dei documenti richiesti non esiste nella forma da noi richiesta, il responsabile della conformità può accettare un documento simile per le esigenze di due diligence.',
        },
        faq: {
            faq: 'FAQ - Domande frequenti',
            title1: 'Cosa significa leva finanziaria?',
            desc1: 'La leva finanziaria è il rapporto tra l\'importo del margine e l\'importo preso in prestito: 1:100, 1:200, 1:1000. La leva 1:100 significa che, per aprire un\'operazione, si deve disporre di un importo 100 volte inferiore all\'importo dell\'operazione. In %%COMPANY_NAME%% potete scegliere la leva da 1:1 a 1:1000.',
            title2: 'È possibile che un trader debba del denaro alla società?',
            desc2: 'No, è impossibile. Se un trader perde più di quanto ha sul conto di trading, la società deve coprire la perdita fino a 0.',
            title3: 'Qual è l\'importo minimo del deposito?',
            desc3: 'Il deposito minimo è di 250 dollari e consente di aprire un\'operazione su qualsiasi strumento.',
            title4: 'C\'è qualche differenza tra il trading demo e quello live?',
            desc4: 'Non ci sono differenze nelle condizioni di trading e negli strumenti di trading. Il trading sul conto demo è identico a quello dal vivo, tranne che per la mancata disponibilità delle opzioni di deposito e prelievo per i conti demo.',
            title5: 'Come si calcola l\'importo del margine per un\'operazione?',
            desc5: 'L\'importo del margine è pari al volume dell\'operazione diviso per la leva finanziaria. Il volume dell\'operazione è pari a 10000 dollari USA moltiplicato per la quantità di lotti e per il tasso di cambio di una valuta di base in una coppia rispetto all\'USD. La valuta di base è la prima di una coppia di valute. Ad esempio, nella coppia di valute EUR/USD la valuta di base è l\'EUR (quindi il tasso di cambio di un\'operazione con il dollaro USA è EURUSD), in USDCAD - è l\'USD (il tasso di cambio di un\'operazione con il dollaro USA è uguale a 1, perché USD/USD = 1), in GBPJPY - la valuta di base è la GBP (il tasso di cambio di un\'operazione con il dollaro USA è uguale al tasso di cambio GBP/USD o al tasso di cambio GBPUSD). Pertanto, quando il tasso di cambio GBPUSD è pari a 1,4956 in un\'operazione di 2 lotti con leva 1:100, il margine sarà di 10000 * 2 * GBPUSD/100 = 299,12 USD. In un\'operazione di 3,4 lotti su USDJPY con leva 1:1000, il margine è pari a 10000 * 3,5 * 1/1000 = 35 USD.',
            title6: 'Quanto guadagnerò se inizio a fare trading sul forex con un deposito minimo?',
            desc6: 'Dipende totalmente dalla vostra esperienza, conoscenza e capacità. Il trading sul Forex/Criptovalute è molto rischioso, e dovete assumervi questo rischio e valutare il vostro livello di professionalità. Le condizioni di investimento del Regno rendono più semplice il passaggio da principiante a trader esperto.',
            title7: 'Quali sono gli orari di lavoro della Borsa?',
            desc7: 'La sessione di trading apre alle 22:00 (GMT+00) di domenica e chiude alle 22:00 (GMT+00) di venerdì.',
            title8: 'Ho dimenticato la mia password (o voglio cambiare la mia password di trader). Cosa devo fare?',
            desc8: 'È possibile modificare la password rivolgendosi al Servizio di assistenza clienti con le seguenti informazioni: indirizzo e-mail, numero di conto. Una volta verificata la vostra identità, vi forniranno un link univoco - dove potrete cambiare la vostra password. (lettere latine, da 6 a 12 simboli). La password del vostro conto sarà recuperata o modificata a vostra discrezione.',
            title9: 'La società applica delle commissioni per il deposito di denaro sul vostro conto? ',
            desc9: '%%COMPANY_NAME%% non applica alcuna commissione per il deposito di denaro sul conto di trading. Tuttavia, l\'importo della transazione verrà addebitato con una commissione dal sistema di pagamento o dalla banca che accredita o addebita il conto.',
            title10: 'Qual è l\'importo minimo di prelievo?',
            desc10: 'Non ci sono limiti al prelievo. È sempre possibile richiedere il prelievo di qualsiasi importo residuo sul proprio conto di trading. Fanno eccezione i bonifici bancari (l\'importo minimo per il prelievo è di 300 dollari). Per i portafogli, i sistemi di pagamento elettronico e le carte bancarie, l\'importo minimo per il prelievo è di 1 USD, commissioni incluse. Inoltre, si prega di prestare attenzione alla commissione che una banca può addebitare per un\'operazione: fino a 30 dollari USA.',
            title11: 'Che cos\'è la verifica del conto? Ho il diritto di operare su un conto non verificato?',
            desc11: 'Per verifica si intende l\'identificazione di un cliente. Protegge il vostro conto di trading dal recupero della password o di altri dati riservati. La procedura di verifica del conto non influisce sulle operazioni con i vostri fondi. Siete invitati a verificare il vostro conto in qualsiasi momento.',
            title12: 'Quanto tempo occorre per verificare un conto?',
            desc12: 'La verifica del conto può richiedere fino a 72 ore lavorative.',
            title13: 'Quali documenti sono necessari per la verifica del conto?',
            desc13: 'Sono accettati tutti i documenti di identità. Sono preferibili il passaporto (ID) o la patente di guida, oltre alle bollette degli ultimi due mesi.',
            title14: 'Ho ricevuto un\'e-mail che mi informa che il mio documento non è stato accettato per la verifica, cosa devo fare?',
            desc14: 'Il documento non viene accettato per la verifica nei seguenti casi: la copia scannerizzata del documento è di bassa qualità. Il documento inviato non è idoneo alla verifica (senza foto o senza nome e cognome). Il documento inviato è già stato utilizzato per il primo livello di verifica o non c\'è una data di scadenza sul documento.',
        },
        contacts: {
            title: 'Contatti',
            desc: 'La soddisfazione del cliente è la nostra massima priorità! Il nostro servizio di assistenza è disponibile 24 ore su 24, 7 giorni su 7, per assistervi in tutte le vostre domande sulla nostra piattaforma: depositi e prelievi, operazioni di trading, conti e impostazioni, ecc.\n' +
                'Potete contattarci nel modo che preferite:',
            label1: 'Name',
            label2: 'E-mail',
            label3: 'Eine Beschreibung eingeben',
            agree: 'Acconsento al trattamento dei dati personali forniti',
        },
        modal: {
            title1: 'Controllare che i dati inseriti siano corretti',
            title2: 'There was an error form was not sent, check your Internet connection!',
            title3: 'The form is being sent, please wait',
            title4: 'Modulo inviato con successo!',
        },
        footer: {
            copy: 'Contracts for Difference (CFDs) are complex financial products that are traded on margin. Trading CFDs carries a high degree of risk. It is possible to lose all your capital. These products may not be suitable for everyone and you should ensure that you understand the risks involved. Seek independent expert advice if necessary and speculate only with funds that you can afford to lose. The content of this page is for information purposes only and it is not intended as a recommendation or advice. The customer carries the sole responsibility for all the businesses or investments that are carried out. We do not offer our services to residents of certain jurisdictions such as Afghanistan, Hong Kong, Japan, the United States of America and some other regions.',
            title1: 'Avvertenza sugli investimenti ad alto rischio: ',
            desc1: 'i contratti per differenza ("CFD") sono prodotti finanziari complessi che vengono negoziati con margine. La negoziazione di CFD comporta un elevato grado di rischio. È possibile perdere l\'intero capitale. Questi prodotti possono non essere adatti a tutti e occorre assicurarsi di aver compreso i rischi connessi. Se necessario, chiedete la consulenza di un esperto indipendente e speculate solo con i fondi che potete permettervi di perdere. Vi invitiamo a riflettere attentamente se questo tipo di trading è adatto a voi, prendendo in considerazione tutte le circostanze pertinenti e le vostre risorse personali. Non raccomandiamo ai clienti di depositare l\'intero saldo del conto per soddisfare i requisiti di margine. I clienti possono ridurre il loro livello di esposizione richiedendo una modifica del limite di leva finanziaria. Per ulteriori informazioni si rimanda alla sezione del sito dedicata all\'informativa sui rischi.',
            title2: 'Disclaimer: ',
            desc2: 'Il contenuto di questa pagina è solo a scopo informativo e non è da intendersi come una raccomandazione o un consiglio. Qualsiasi indicazione di performance passata o di performance passata simulata inclusa nelle pubblicità pubblicate non è un indicatore affidabile di risultati futuri. Il cliente è l\'unico responsabile di tutte le attività o gli investimenti effettuati.',
            title3: 'Restrizioni regionali: ',
            desc3: 'non offriamo i nostri servizi ai residenti di alcune giurisdizioni come Afghanistan, Hong Kong, Giappone, Stati Uniti d\'America e alcune altre regioni.',
            copyText: 'Copyright ',
        }
    },
    fr: {
